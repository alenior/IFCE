...
////                                                                   ////
//// BT_FRIENDLY_NAME                                                  ////
//// BT_FRIENDLY_NAME_MAC                                              ////
////  Optional.  If defined, during the init process the name of       ////
////  the Bluetooth module will be set to this.  This will be          ////
////  more efficient to use this than temporarily putting the unit     ////
////  into command mode to change the name since during the init       ////
////  process the unit is already in command mode.  The MAC version    ////
////  of this macro will append the last 3 bytes of the MAC address    ////
////  to the friendly name.  This must be a constant string in ROM,    ////
////  it cannot point to a variable in RAM.                            ////
////  Example:  #define BT_FRIENDLY_NAME_MAC "MyDevice"                ////
////                                                                   ////
//// BT_GET_VERSION_INFO                                               ////
////  Optional.  If defined, during the init process the version info  ////
////  string will be read from the module and saved here.  The         ////
////  version string can be quite lengthy, it is recommended to        ////
////  allocate at least 32 bytes.  BT_MAX_VERSION_INFO must also be    ////
////  defined that tells the driver how many bytes were allocated      ////
////  at BT_GET_VERSION_INFO.                                          ////
////     Example:                                                      ////
