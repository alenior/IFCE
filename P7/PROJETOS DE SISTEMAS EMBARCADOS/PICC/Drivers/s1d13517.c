...
//                                                                           //
//    glcd_Init(void)                                                        //
//       - Initializes the controller hardware and sets up the controller to //
...
//       - Enable transparency and sets the transparent pixel color.         //
//                                                                           //
...
//         is used by the driver to determine delays to meet timing          //
//         specification of the display controller.                          //
//                                                                           //
//    GLCD_CS                                                                //
//       - Specifies the PIC pin connected to the display controller's HCS   //
//         pin, default is PIN_F4.                                           //
//                                                                           //
//    GLCD_RE                                                                //
//       - Specifies the PIC pin connected to the display controller's HRE#  //
//         pin, default is PIN_F5.                                           //
//                                                                           //
//    GLCD_WE                                                                //
//       - Specifies the PIC pin connected to the display controller's HWE#  //
...
//                                                                           //
//    GLCD_DC                                                                //
//       - Specifies the PIC pin connected to the display controller's HD/C# //
//         pin, default is PIN_F0.                                           //
//                                                                           //
//    GLCD_INIT                                                              //
//       - Specifies the PIC pin connected to the display controller's TE    //
...
//
//    color - the RGB 565 color to set the pixel to.
//
///////////////////////////////////////////////////////////////////////////////
void glcd_DrawPixel(uint16_t x, uint16_t y, uint16_t color)
{
   ...
   if(glcd_TransparencyEnabled == TRUE)
      iColor = glcd_TransparencyColor;
   else
      iColor = color ^ 0xFFFF;
   ...
   if(glcd_TransparencyEnabled == FALSE)
   {   
...
///////////////////////////////////////////////////////////////////////////////
// glcd_EnableTransparency()
//
// Enables transparency and sets the transparent pixel color.
//
// Parameters:
//    Color - the RGB 565 color to be transparent.
//
///////////////////////////////////////////////////////////////////////////////
void glcd_EnableTransparency(uint16_t Color)
{
   output_low(GLCD_CS);
   
   glcd_WriteRegister(GLCD_INPUT_MODE, 0x08, FALSE);
               
   glcd_WriteRegister(GLCD_TRANS_KEY_COLOR_RED, make8(Color, 1) & 0xF8, FALSE);
   glcd_WriteRegister(GLCD_TRANS_KEY_COLOR_GREEN, (Color & 0x07E0) >> 3, FALSE);
   glcd_WriteRegister(GLCD_TRANS_KEY_COLOR_BLUE, (make8(Color, 0) & 0x1F) << 3, FALSE);
   
   output_high(GLCD_CS);
   
   glcd_TransparencyEnabled = TRUE;
   glcd_TransparencyColor = Color;
}
...
//
///////////////////////////////////////////////////////////////////////////////
void glcd_DisableTransparency(void)
{
   glcd_WriteRegister(GLCD_INPUT_MODE, 0x00, TRUE);
   
   glcd_TransparencyEnabled = FALSE;
}
