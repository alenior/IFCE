...
////   #use spi() library, which is extremely flexible, and the        ////
////   spi_transfer() functions.  #use spi() allows the user to        ////
////   specify many options, including SPI mode, speed, # of bits, and ////
////   which pins to use.  #use spi() will automatically use hardware  ////
////   SPI peripheral, if configured to do so, otherwise will fallback ////
////   and manually big-bang the GPIO for SPI.                         ////
////                                                                   ////
////   CCS also provides 9356bitbang.c driver, in which the GPIO       ////
////   pins are manually bit banged, 9356spi.c driver, in which the    ////
////   legacy SPI functions are used, and 9356xfer.c driver, in which  ////
////   the #use spi() library is used with the spi_xfer() functions.   ////
////                                                                   ////
///////////////////////////////////////////////////////////////////////////
...
////  the library will fall back to bit banging those GPIO pins.       ////
////                                                                   ////
////                                                                   ////
////  Required configuration:                                          ////
////  ---------------------------------------------------------        ////
////     EEPROM_SELECT - Chip select, active high                      ////
...
#use spi(master, di=EEPROM_DO, do=EEPROM_DI, clk=EEPROM_CLK, mode=0, baud=1000000, stream=STREAM_SPI_9356, bits=8, SAMPLE_END)
