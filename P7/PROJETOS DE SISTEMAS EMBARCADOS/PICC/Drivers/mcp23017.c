...
{
   mcp23017_write_bytes(MCP23017_REG_IODIRA, (unsigned int8*)&tris, sizeof(tris));
}  
...
unsigned int16 mcp23017_input(void)
{
   ...
   mcp23017_read_bytes((unsigned int8*)&ret, MCP23017_REG_GPIOA, sizeof(ret));
...
{
   mcp23017_write_bytes(MCP23017_REG_OLATA, (unsigned int8*)&val, sizeof(val));
}
...
unsigned int16 mcp23017_get_latch(void)
{
   ...
   mcp23017_read_bytes((unsigned int8*)&ret, MCP23017_REG_OLATA, sizeof(ret));
