...
#ifndef TOUCH_RELEASE_RATE
 #define TOUCH_RELEASE_RATE   (GFX_TICKS_PER_SECOND / 10)   //100ms
#endif
...
typedef void(*_touchpfunc)(HANDLE_ID HandleId, uint8_t AreaIndex, TOUCH_TYPE Kind, uint16_t x, uint16_t y);
...
#else
 #define gfx_BacklightOn() 
 #define gfx_BacklightOff()
#endif
...
#define SERIAL_CMD_IMAGE_HANDLE        0x0D

#define SERIAL_CMD_SET_TOUCH_CALLBACK  0x0C
#define SERIAL_CMD_TOUCH_CALLBACK      0x20
...
#define ENABLE_SERIAL_TOUCH            1
#define DISABLE_SERIA_TOUCH            0
...
#define GFX_MAKE_RGB565_COLOR(red, green, blue) ((((uint16_t)red << 8) & 0xF800) | (((uint16_t)green << 3) & 0x07E0) | (((uint16_t)blue >> 3) & 0x001F))
...
#define GFX_COLOR_PURPLE   0x4010
#define GFX_COLOR_CYAN     0x07FF
#define GFX_COLOR_PINK     0xF81F
#define GFX_COLOR_BLACK    0x0000
#define GFX_COLOR_GREY     0x8410
#define GFX_COLOR_WHITE    0xFFFF
#define GFX_COLOR_BROWN    0x8200
