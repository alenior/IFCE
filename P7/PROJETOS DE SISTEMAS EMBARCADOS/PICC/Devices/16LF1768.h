//////////// Standard Header file for the PIC16LF1768 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
// Input Functions: 
//    INT0,T0CK,T1CK,T1G,CCP1,CCP2,COG1IN,COG2IN,T2CK,T3CK,T3G,T4CK,T5CK,T5G,
//    T6CK,SCK1IN,SCL1IN,SDI1,SDA1IN,SS1IN,U1RX,U1CKIN,CLCIN0,CLCIN1,CLCIN2,
//    CLCIN3,PRG1F,PRG1R,PRG2F,PRG2R,MD1CH,MD1CL,MD1MOD,MD2CH,MD2CL,MD2MOD,T0CKI,
//    T1CKI,T2CKI,T3CKI,T4CKI,T5CKI,T6CKI,RX1
// Output Functions: 
//    NULL,CLC1OUT,CLC2OUT,CLC3OUT,COG1A,COG1B,COG1C,COG1D,COG2A,COG2B,COG2C,
//    COG2D,CCP1OUT,CCP2OUT,PWM3OUT,PWM4OUT,PWM5OUT,PWM6OUT,SCK1OUT,SCL1OUT,
//    SDA1OUT,SDO1,U1TX,U1DT,C1OUT,C2OUT,C3OUT,C4OUT,MD1OUT,MD2OUT,PWM3,PWM4,
//    PWM5,PWM6,SCK1,SCL1,SDA1,TX1,DT1
//
...
#define T2_RESET_FROM_PWM5                         0x08000000 
#define T2_RESET_FROM_PWM6                         0x09000000  
#define T2_RESET_FROM_C1OUT                        0x0A000000 
#define T2_RESET_FROM_C2OUT                        0x0B000000 
#define T2_RESET_FROM_C3OUT                        0x0C000000  
#define T2_RESET_FROM_C4OUT                        0x0D000000  
#define T2_RESET_FROM_ZCD1                         0x0E000000 
#define T2_RESET_FROM_CLC1                         0x0F000000 
#define T2_RESET_FROM_CLC2                         0x10000000 
#define T2_RESET_FROM_CLC3                         0x11000000 
...
#define T4_RESET_FROM_PWM5                         0x08000000 
#define T4_RESET_FROM_PWM6                         0x09000000  
#define T4_RESET_FROM_C1OUT                        0x0A000000 
#define T4_RESET_FROM_C2OUT                        0x0B000000 
#define T4_RESET_FROM_C3OUT                        0x0C000000  
#define T4_RESET_FROM_C4OUT                        0x0D000000  
#define T4_RESET_FROM_ZCD1                         0x0E000000 
#define T4_RESET_FROM_CLC1                         0x0F000000 
#define T4_RESET_FROM_CLC2                         0x10000000 
#define T4_RESET_FROM_CLC3                         0x11000000 
...
#define T6_RESET_FROM_PWM5                         0x08000000 
#define T6_RESET_FROM_PWM6                         0x09000000  
#define T6_RESET_FROM_C1OUT                        0x0A000000 
#define T6_RESET_FROM_C2OUT                        0x0B000000 
#define T6_RESET_FROM_C3OUT                        0x0C000000  
#define T6_RESET_FROM_C4OUT                        0x0D000000  
#define T6_RESET_FROM_ZCD1                         0x0E000000 
#define T6_RESET_FROM_CLC1                         0x0F000000 
#define T6_RESET_FROM_CLC2                         0x10000000 
#define T6_RESET_FROM_CLC3                         0x11000000 
...
#define CCP_CAPTURE_INPUT_IOC_INTERRUPT  0x070000 
...
// Constants used for SETUP_PWM3() and SETUP_PWM4 are: 
...
//Constants used for SETUP_PWM5() and SETUP_PWM6() first parameter are: 
...
// Constants used for SETUP_PWM5() and SETUP_PWM6() second parameter are: 
...
//ENABLE_PWM6_INTERRUPT(), DISABLE_PWM6_INTERRUPT(), CLEAR_PWM6_INTERRUPT(), and PWM6_INTERRUPT_ACTIVE() are: 
...
#define CP1_PRG1_A0     0x8004
#define CP1_PRG2_A0     0x8005 
#define CP1_FVR_A0      0x8006
#define CP1_VSS_A0      0x8007
#define CP1_A1_B6       0x8010 
#define CP1_C1_B6       0x8011 
#define CP1_C2_B6       0x8012 
#define CP1_C3_B6       0x8013 
#define CP1_PRG1_B6     0x8014 
#define CP1_PRG2_B6     0x8015 
#define CP1_FVR_B6      0x8016 
#define CP1_VSS_B6      0x8017 
#define CP1_A1_PRG1     0x8080
#define CP1_C1_PRG1     0x8081
#define CP1_C2_PRG1     0x8082
#define CP1_C3_PRG1     0x8083
#define CP1_PRG1_PRG1   0x8084
#define CP1_PRG2_PRG1   0x8085 
#define CP1_FVR_PRG1    0x8086
#define CP1_VSS_PRG1    0x8087
#define CP1_A1_PRG2     0x8090 
#define CP1_C1_PRG2     0x8091 
#define CP1_C2_PRG2     0x8092 
#define CP1_C3_PRG2     0x8093 
#define CP1_PRG1_PRG2   0x8094 
#define CP1_PRG2_PRG2   0x8095 
#define CP1_FVR_PRG2    0x8096 
#define CP1_VSS_PRG2    0x8097 
#define CP1_A1_DAC1     0x80A0
#define CP1_C1_DAC1     0x80A1
#define CP1_C2_DAC1     0x80A2
#define CP1_C3_DAC1     0x80A3
#define CP1_PRG1_DAC1   0x80A4
#define CP1_PRG2_DAC1   0x80A5 
#define CP1_FVR_DAC1    0x80A6
#define CP1_VSS_DAC1    0x80A7
#define CP1_A1_DAC2     0x80B0 
#define CP1_C1_DAC2     0x80B1 
#define CP1_C2_DAC2     0x80B2 
#define CP1_C3_DAC2     0x80B3 
#define CP1_PRG1_DAC2   0x80B4 
#define CP1_PRG2_DAC2   0x80B5 
#define CP1_FVR_DAC2    0x80B6 
#define CP1_VSS_DAC2    0x80B7 
#define CP1_A1_DAC3     0x80C0
#define CP1_C1_DAC3     0x80C1
#define CP1_C2_DAC3     0x80C2
#define CP1_C3_DAC3     0x80C3
#define CP1_PRG1_DAC3   0x80C4
#define CP1_PRG2_DAC3   0x80C5 
#define CP1_FVR_DAC3    0x80C6
#define CP1_VSS_DAC3    0x80C7
#define CP1_A1_DAC4     0x80D0 
#define CP1_C1_DAC4     0x80D1 
#define CP1_C2_DAC4     0x80D2 
#define CP1_C3_DAC4     0x80D3 
#define CP1_PRG1_DAC4   0x80D4 
#define CP1_PRG2_DAC4   0x80D5 
#define CP1_FVR_DAC4    0x80D6 
#define CP1_VSS_DAC4    0x80D7 
#define CP1_A1_FVR      0x80E0
#define CP1_C1_FVR      0x80E1
#define CP1_C2_FVR      0x80E2
#define CP1_C3_FVR      0x80E3
#define CP1_PRG1_FVR    0x80E4
#define CP1_PRG2_FVR    0x80E5 
#define CP1_FVR_FVR     0x80E6
#define CP1_VSS_FVR     0x80E7
#define CP1_A1_VSS      0x80F0
#define CP1_C1_VSS      0x80F1
#define CP1_C2_VSS      0x80F2
#define CP1_C3_VSS      0x80F3
#define CP1_PRG1_VSS    0x80F4
#define CP1_PRG2_VSS    0x80F5 
#define CP1_FVR_VSS     0x80F6
#define CP1_VSS_VSS     0x80F7
...
#define CP2_C1_C0       0x8001
#define CP2_C2_C0       0x8002
#define CP2_C3_C0       0x8003
#define CP2_PRG1_C0     0x8004
#define CP2_PRG2_C0     0x8005 
#define CP2_FVR_C0      0x8006
#define CP2_VSS_C0      0x8007
#define CP2_A1_B7       0x8010 
#define CP2_C1_B7       0x8011 
#define CP2_C2_B7       0x8012 
#define CP2_C3_B7       0x8013 
#define CP2_PRG1_B7     0x8014 
#define CP2_PRG2_B7     0x8015 
#define CP2_FVR_B7      0x8016 
#define CP2_VSS_B7      0x8017 
#define CP2_A1_PRG1     0x8080
#define CP2_C1_PRG1     0x8081
#define CP2_C2_PRG1     0x8082
#define CP2_C3_PRG1     0x8083
#define CP2_PRG1_PRG1   0x8084
#define CP2_PRG2_PRG1   0x8085 
#define CP2_FVR_PRG1    0x8086
#define CP2_VSS_PRG1    0x8087
#define CP2_A1_PRG2     0x8090 
#define CP2_C1_PRG2     0x8091 
#define CP2_C2_PRG2     0x8092 
#define CP2_C3_PRG2     0x8093 
#define CP2_PRG1_PRG2   0x8094 
#define CP2_PRG2_PRG2   0x8095 
#define CP2_FVR_PRG2    0x8096 
#define CP2_VSS_PRG2    0x8097 
#define CP2_A1_DAC1     0x80A0
#define CP2_C1_DAC1     0x80A1
#define CP2_C2_DAC1     0x80A2
#define CP2_C3_DAC1     0x80A3
#define CP2_PRG1_DAC1   0x80A4
#define CP2_PRG2_DAC1   0x80A5 
#define CP2_FVR_DAC1    0x80A6
#define CP2_VSS_DAC1    0x80A7
#define CP2_A1_DAC2     0x80B0 
#define CP2_C1_DAC2     0x80B1 
#define CP2_C2_DAC2     0x80B2 
#define CP2_C3_DAC2     0x80B3 
#define CP2_PRG1_DAC2   0x80B4 
#define CP2_PRG2_DAC2   0x80B5 
#define CP2_FVR_DAC2    0x80B6 
#define CP2_VSS_DAC2    0x80B7 
#define CP2_A1_DAC3     0x80C0
#define CP2_C1_DAC3     0x80C1
#define CP2_C2_DAC3     0x80C2
#define CP2_C3_DAC3     0x80C3
#define CP2_PRG1_DAC3   0x80C4
#define CP2_PRG2_DAC3   0x80C5 
#define CP2_FVR_DAC3    0x80C6
#define CP2_VSS_DAC3    0x80C7
#define CP2_A1_DAC4     0x80D0 
#define CP2_C1_DAC4     0x80D1 
#define CP2_C2_DAC4     0x80D2 
#define CP2_C3_DAC4     0x80D3 
#define CP2_PRG1_DAC4   0x80D4 
#define CP2_PRG2_DAC4   0x80D5 
#define CP2_FVR_DAC4    0x80D6 
#define CP2_VSS_DAC4    0x80D7 
#define CP2_A1_FVR      0x80E0
#define CP2_C1_FVR      0x80E1
#define CP2_C2_FVR      0x80E2
#define CP2_C3_FVR      0x80E3
#define CP2_PRG1_FVR    0x80E4
#define CP2_PRG2_FVR    0x80E5 
#define CP2_FVR_FVR     0x80E6
#define CP2_VSS_FVR     0x80E7
#define CP2_A1_VSS      0x80F0
#define CP2_C1_VSS      0x80F1
#define CP2_C2_VSS      0x80F2
#define CP2_C3_VSS      0x80F3
#define CP2_PRG1_VSS    0x80F4
#define CP2_PRG2_VSS    0x80F5 
#define CP2_FVR_VSS     0x80F6
#define CP2_VSS_VSS     0x80F7
//Optionally OR any of the following with the above
...
// Pick one of the following 
#define CP3_A1_A0       0x8000 
#define CP3_C1_A0       0x8001 
#define CP3_C2_A0       0x8002 
#define CP3_C3_A0       0x8003 
#define CP3_PRG1_A0     0x8004 
#define CP3_PRG2_A0     0x8005 
#define CP3_FVR_A0      0x8006 
#define CP3_VSS_A0      0x8007 
#define CP3_A1_B6       0x8010 
#define CP3_C1_B6       0x8011 
#define CP3_C2_B6       0x8012 
#define CP3_C3_B6       0x8013 
#define CP3_PRG1_B6     0x8014 
#define CP3_PRG2_B6     0x8015 
#define CP3_FVR_B6      0x8016 
#define CP3_VSS_B6      0x8017 
#define CP3_A1_PRG1     0x8080 
#define CP3_C1_PRG1     0x8081 
#define CP3_C2_PRG1     0x8082 
#define CP3_C3_PRG1     0x8083 
#define CP3_PRG1_PRG1   0x8084 
#define CP3_PRG2_PRG1   0x8085 
#define CP3_FVR_PRG1    0x8086 
#define CP3_VSS_PRG1    0x8087 
#define CP3_A1_PRG2     0x8090 
#define CP3_C1_PRG2     0x8091 
#define CP3_C2_PRG2     0x8092 
#define CP3_C3_PRG2     0x8093 
#define CP3_PRG1_PRG2   0x8094 
#define CP3_PRG2_PRG2   0x8095 
#define CP3_FVR_PRG2    0x8096 
#define CP3_VSS_PRG2    0x8097 
#define CP3_A1_DAC1     0x80A0 
#define CP3_C1_DAC1     0x80A1 
#define CP3_C2_DAC1     0x80A2 
#define CP3_C3_DAC1     0x80A3 
#define CP3_PRG1_DAC1   0x80A4 
#define CP3_PRG2_DAC1   0x80A5 
#define CP3_FVR_DAC1    0x80A6 
#define CP3_VSS_DAC1    0x80A7 
#define CP3_A1_DAC2     0x80B0 
#define CP3_C1_DAC2     0x80B1 
#define CP3_C2_DAC2     0x80B2 
#define CP3_C3_DAC2     0x80B3 
#define CP3_PRG1_DAC2   0x80B4 
#define CP3_PRG2_DAC2   0x80B5 
#define CP3_FVR_DAC2    0x80B6 
#define CP3_VSS_DAC2    0x80B7 
#define CP3_A1_DAC3     0x80C0 
#define CP3_C1_DAC3     0x80C1 
#define CP3_C2_DAC3     0x80C2 
#define CP3_C3_DAC3     0x80C3 
#define CP3_PRG1_DAC3   0x80C4 
#define CP3_PRG2_DAC3   0x80C5 
#define CP3_FVR_DAC3    0x80C6 
#define CP3_VSS_DAC3    0x80C7 
#define CP3_A1_DAC4     0x80D0 
#define CP3_C1_DAC4     0x80D1 
#define CP3_C2_DAC4     0x80D2 
#define CP3_C3_DAC4     0x80D3 
#define CP3_PRG1_DAC4   0x80D4 
#define CP3_PRG2_DAC4   0x80D5 
#define CP3_FVR_DAC4    0x80D6 
#define CP3_VSS_DAC4    0x80D7 
#define CP3_A1_FVR      0x80E0 
#define CP3_C1_FVR      0x80E1 
#define CP3_C2_FVR      0x80E2 
#define CP3_C3_FVR      0x80E3 
#define CP3_PRG1_FVR    0x80E4 
#define CP3_PRG2_FVR    0x80E5 
#define CP3_FVR_FVR     0x80E6 
#define CP3_VSS_FVR     0x80E7 
#define CP3_A1_VSS      0x80F0 
#define CP3_C1_VSS      0x80F1 
#define CP3_C2_VSS      0x80F2 
#define CP3_C3_VSS      0x80F3 
#define CP3_PRG1_VSS    0x80F4 
#define CP3_PRG2_VSS    0x80F5 
#define CP3_FVR_VSS     0x80F6 
#define CP3_VSS_VSS     0x80F7 
//Optionally OR any of the following with the above 
...
// Pick one of the following 
#define CP4_A1_C0       0x8000 
#define CP4_C1_C0       0x8001 
#define CP4_C2_C0       0x8002 
#define CP4_C3_C0       0x8003 
#define CP4_PRG1_C0     0x8004 
#define CP4_PRG2_C0     0x8005 
#define CP4_FVR_C0      0x8006 
#define CP4_VSS_C0      0x8007 
#define CP4_A1_B7       0x8010 
#define CP4_C1_B7       0x8011 
#define CP4_C2_B7       0x8012 
#define CP4_C3_B7       0x8013 
#define CP4_PRG1_B7     0x8014 
#define CP4_PRG2_B7     0x8015 
#define CP4_FVR_B7      0x8016 
#define CP4_VSS_B7      0x8017 
#define CP4_A1_PRG1     0x8080 
#define CP4_C1_PRG1     0x8081 
#define CP4_C2_PRG1     0x8082 
#define CP4_C3_PRG1     0x8083 
#define CP4_PRG1_PRG1   0x8084 
#define CP4_PRG2_PRG1   0x8085 
#define CP4_FVR_PRG1    0x8086 
#define CP4_VSS_PRG1    0x8087 
#define CP4_A1_PRG2     0x8090 
#define CP4_C1_PRG2     0x8091 
#define CP4_C2_PRG2     0x8092 
#define CP4_C3_PRG2     0x8093 
#define CP4_PRG1_PRG2   0x8094 
#define CP4_PRG2_PRG2   0x8095 
#define CP4_FVR_PRG2    0x8096 
#define CP4_VSS_PRG2    0x8097 
#define CP4_A1_DAC1     0x80A0 
#define CP4_C1_DAC1     0x80A1 
#define CP4_C2_DAC1     0x80A2 
#define CP4_C3_DAC1     0x80A3 
#define CP4_PRG1_DAC1   0x80A4 
#define CP4_PRG2_DAC1   0x80A5 
#define CP4_FVR_DAC1    0x80A6 
#define CP4_VSS_DAC1    0x80A7 
#define CP4_A1_DAC2     0x80B0 
#define CP4_C1_DAC2     0x80B1 
#define CP4_C2_DAC2     0x80B2 
#define CP4_C3_DAC2     0x80B3 
#define CP4_PRG1_DAC2   0x80B4 
#define CP4_PRG2_DAC2   0x80B5 
#define CP4_FVR_DAC2    0x80B6 
#define CP4_VSS_DAC2    0x80B7 
#define CP4_A1_DAC3     0x80C0 
#define CP4_C1_DAC3     0x80C1 
#define CP4_C2_DAC3     0x80C2 
#define CP4_C3_DAC3     0x80C3 
#define CP4_PRG1_DAC3   0x80C4 
#define CP4_PRG2_DAC3   0x80C5 
#define CP4_FVR_DAC3    0x80C6 
#define CP4_VSS_DAC3    0x80C7 
#define CP4_A1_DAC4     0x80D0 
#define CP4_C1_DAC4     0x80D1 
#define CP4_C2_DAC4     0x80D2 
#define CP4_C3_DAC4     0x80D3 
#define CP4_PRG1_DAC4   0x80D4 
#define CP4_PRG2_DAC4   0x80D5 
#define CP4_FVR_DAC4    0x80D6 
#define CP4_VSS_DAC4    0x80D7 
#define CP4_A1_FVR      0x80E0 
#define CP4_C1_FVR      0x80E1 
#define CP4_C2_FVR      0x80E2 
#define CP4_C3_FVR      0x80E3 
#define CP4_PRG1_FVR    0x80E4 
#define CP4_PRG2_FVR    0x80E5 
#define CP4_FVR_FVR     0x80E6 
#define CP4_VSS_FVR     0x80E7 
#define CP4_A1_VSS      0x80F0 
#define CP4_C1_VSS      0x80F1 
#define CP4_C2_VSS      0x80F2 
#define CP4_C3_VSS      0x80F3 
#define CP4_PRG1_VSS    0x80F4 
#define CP4_PRG2_VSS    0x80F5 
#define CP4_FVR_VSS     0x80F6 
#define CP4_VSS_VSS     0x80F7 
//Optionally OR any of the following with the above 
...
#define OPAMP_I_TO_DAC1                   0x0002 //Inverting input connects to DAC1 output 
#define OPAMP_I_TO_DAC2                   0x0003 //Inverting input connects to DAC2 output 
#define OPAMP_I_TO_DAC3                   0x0004 //Inverting input connects to DAC3 output 
#define OPAMP_I_TO_DAC4                   0x0005 //Inverting input connects to DAC4 output 
#define OPAMP_I_TO_FVR                    0x0006 //Inverting input connects to FVR Buffer 2 output 
#define OPAMP_I_TO_PRG1                   0x0008 //Inverting input connects to PRG1 output 
#define OPAMP_I_TO_PRG2                   0x0009 //Inverting input connects to PRG2 output 
// One of the following may be OR'ed in with the above using |    
...
#define OPAMP_NI_TO_DAC1                  0x0020 //Non-inverting input connects to DAC1 output 
#define OPAMP_NI_TO_DAC2                  0x0030 //Non-inverting input connects to DAC2 output 
#define OPAMP_NI_TO_DAC3                  0x0040 //Non-inverting input connects to DAC3 output 
#define OPAMP_NI_TO_DAC4                  0x0050 //Non-inverting input connects to DAC4 output 
#define OPAMP_NI_TO_FVR                   0x0060 //Non-inverting input connects to FVR Buffer 2 output 
#define OPAMP_NI_TO_PRG1                  0x0080 //Non-inverting input connects to PRG1 output 
#define OPAMP_NI_TO_PRG2                  0x0090 //Non-inverting input connects to PRG2 output 
// One of the following may be OR'ed in with the above using |    
...
#define OPAMP_OVERRIDE_SOURCE_PWM3      0x020000 
#define OPAMP_OVERRIDE_SOURCE_PWM4      0x030000 
#define OPAMP_OVERRIDE_SOURCE_PWM5      0x040000 
#define OPAMP_OVERRIDE_SOURCE_PWM6      0x050000 
#define OPAMP_OVERRIDE_SOURCE_C1OUT     0x060000 
#define OPAMP_OVERRIDE_SOURCE_C2OUT     0x070000 
#define OPAMP_OVERRIDE_SOURCE_C3OUT     0x080000 
#define OPAMP_OVERRIDE_SOURCE_C4OUT     0x090000 
#define OPAMP_OVERRIDE_SOURCE_ZCD1      0x0A0000 
#define OPAMP_OVERRIDE_SOURCE_CLC1      0x0B0000 
#define OPAMP_OVERRIDE_SOURCE_CLC2      0x0C0000 
#define OPAMP_OVERRIDE_SOURCE_CLC3      0x0D0000 
#define OPAMP_OVERRIDE_SOURCE_COG1A     0x0E0000 
#define OPAMP_OVERRIDE_SOURCE_COG1B     0x0F0000 
#define OPAMP_OVERRIDE_SOURCE_COG1C     0x100000 
#define OPAMP_OVERRIDE_SOURCE_COG1D     0x110000 
#define OPAMP_OVERRIDE_SOURCE_COG2A     0x120000 
#define OPAMP_OVERRIDE_SOURCE_COG2B     0x130000 
#define OPAMP_OVERRIDE_SOURCE_COG2C     0x140000 
#define OPAMP_OVERRIDE_SOURCE_COG2D     0x150000 
// The following may be OR'ed in with the above using |    
...
#define CLC_INPUT_C1OUT                     0x07 
#define CLC_INPUT_C2OUT                     0x08 
#define CLC_INPUT_C3OUT                     0x09 
#define CLC_INPUT_C4OUT                     0x0A 
#define CLC_INPUT_COG1A                     0x0B 
#define CLC_INPUT_COG1B                     0x0C 
#define CLC_INPUT_COG2A                     0x0D 
#define CLC_INPUT_COG2B                     0x0E 
#define CLC_INPUT_CCP1OUT                   0x0F 
#define CLC_INPUT_CCP2OUT                   0x10 
#define CLC_INPUT_PWM3                      0x11 
#define CLC_INPUT_PWM4                      0x12 
#define CLC_INPUT_PWM5                      0x13 
#define CLC_INPUT_PWM6                      0x14 
#define CLC_INPUT_SCK1_SCL1                 0x15 
#define CLC_INPUT_SDO1_SDA1                 0x16 
#define CLC_INPUT_ZCD1                      0x17 
#define CLC_INPUT_U1TX                      0x18 
#define CLC_INPUT_U1RX                      0x19 
#define CLC_INPUT_TIMER0                    0x1A 
#define CLC_INPUT_TIMER1                    0x1B 
#define CLC_INPUT_TIMER3                    0x1C 
#define CLC_INPUT_TIMER5                    0x1D 
#define CLC_INPUT_TIMER2                    0x1E 
#define CLC_INPUT_TIMER4                    0x1F 
#define CLC_INPUT_TIMER6                    0x20 
#define CLC_INPUT_IOC                       0x21 
#define CLC_INPUT_ADCRC                     0x22 
#define CLC_INPUT_LFINTOSC                  0x23 
#define CLC_INPUT_HFINTOSC                  0x24 
#define CLC_INPUT_FOSC                      0x25 
...
#define PRG_MODE_RISING_RAMP_GENERATOR          0x0C00 
// One of the following may be OR'ed in with the above using |
...
#define PRG_INPUT_SOURCE_DAC1                   0x030000 
#define PRG_INPUT_SOURCE_DAC2                   0x040000 
#define PRG_INPUT_SOURCE_DAC3                   0x050000 
#define PRG_INPUT_SOURCE_DAC4                   0x060000 

// Constants used in SETUP_PRGx() third parameter are:
#define PRG_RISING_SOURCE_C1OUT                 0 
#define PRG_RISING_SOURCE_C2OUT                 0x01 
#define PRG_RISING_SOURCE_C3OUT                 0x02 
#define PRG_RISING_SOURCE_C4OUT                 0x03 
#define PRG_RISING_SOURCE_PRGR                  0x04 //PRGxR Pin 
#define PRG_RISING_SOURCE_PWM3                  0x05 
#define PRG_RISING_SOURCE_PWM4                  0x06 
#define PRG_RISING_SOURCE_PWM5                  0x07 
#define PRG_RISING_SOURCE_PWM6                  0x08 
#define PRG_RISING_SOURCE_CCP1                  0x09 
#define PRG_RISING_SOURCE_CCP2                  0x0A 

// Constants used in SETUP_PRGx() fourth parameter are:
#define PRG_FALLING_SOURCE_C1OUT                0 
#define PRG_FALLING_SOURCE_C2OUT                0x01 
#define PRG_FALLING_SOURCE_C3OUT                0x02 
#define PRG_FALLING_SOURCE_C4OUT                0x03 
#define PRG_FALLING_SOURCE_PRGR                 0x04 //PRGxR Pin 
#define PRG_FALLING_SOURCE_PWM3                 0x05 
#define PRG_FALLING_SOURCE_PWM4                 0x06 
#define PRG_FALLING_SOURCE_PWM5                 0x07 
#define PRG_FALLING_SOURCE_PWM6                 0x08 
#define PRG_FALLING_SOURCE_CCP1                 0x09  
#define PRG_FALLING_SOURCE_CCP2                 0x0A 
...
// Constants used in SETUP_COG() and SETUP_COG2() first parameter are: 
...
#define COG_FALLING_SOURCE_C3OUT                 0x040000 
#define COG_FALLING_SOURCE_C4OUT                 0x050000 
#define COG_FALLING_SOURCE_CCP1                  0x060000 
#define COG_FALLING_SOURCE_CCP2                  0x070000 
#define COG_FALLING_SOURCE_PWM3                  0x080000 
#define COG_FALLING_SOURCE_PWM4                  0x090000 
#define COG_FALLING_SOURCE_PWM5                  0x0A0000 
#define COG_FALLING_SOURCE_PWM6                  0x0B0000 
#define COG_FALLING_SOURCE_CLC1                  0x0C0000 
#define COG_FALLING_SOURCE_CLC2                  0x0D0000 
#define COG_FALLING_SOURCE_CLC3                  0x0E0000 
// One of the following may be OR'ed in with the above using |
...
#define COG_RISING_SOURCE_C3OUT                  0x04000000 
#define COG_RISING_SOURCE_C4OUT                  0x05000000 
#define COG_RISING_SOURCE_CCP1                   0x06000000 
#define COG_RISING_SOURCE_CCP2                   0x07000000 
#define COG_RISING_SOURCE_PWM3                   0x08000000 
#define COG_RISING_SOURCE_PWM4                   0x09000000 
#define COG_RISING_SOURCE_PWM5                   0x0A000000 
#define COG_RISING_SOURCE_PWM6                   0x0B000000 
#define COG_RISING_SOURCE_CLC1                   0x0C000000 
#define COG_RISING_SOURCE_CLC2                   0x0D000000 
#define COG_RISING_SOURCE_CLC3                   0x0E000000 

// Constants used in SETUP_COG() and SETUP_COG2() second parameter are: 
...
// Constants used in SETUP_COG() and SETUP_COG2() third parameter are: 
// One of the following may be used:
...
// Constants returned from COG_STATUS() and COG2_STATUS() are: 
...
// Constants used in SETUP_DSM() and SETUP_DSM2() first parameter are: 
...
#define DSM_SOURCE_COG1A                0x02 
#define DSM_SOURCE_U1TX                 0x03 
#define DSM_SOURCE_U1DT                 0x04 
#define DSM_SOURCE_COG2A                0x05 
#define DSM_SOURCE_SDO1                 0x06 
#define DSM_SOURCE_CCP1                 0x07 
#define DSM_SOURCE_CCP2                 0x08 
#define DSM_SOURCE_PWM3                 0x09 
#define DSM_SOURCE_PWM4                 0x0A 
#define DSM_SOURCE_PWM5                 0x0B 
#define DSM_SOURCE_PWM6                 0x0C 
#define DSM_SOURCE_CLC1                 0x0D 
#define DSM_SOURCE_CLC2                 0x0E 
#define DSM_SOURCE_CLC3                 0x0F 
#define DSM_SOURCE_C1OUT                0x10 
#define DSM_SOURCE_C2OUT                0x11 
#define DSM_SOURCE_C3OUT                0x12 
#define DSM_SOURCE_C4OUT                0x13 
...
#define DSM_CARRIER_LOW_CCP1            0x0007 
#define DSM_CARRIER_LOW_CCP2            0x0008 
#define DSM_CARRIER_LOW_PWM3            0x0009 
#define DSM_CARRIER_LOW_PWM4            0x000A 
#define DSM_CARRIER_LOW_PWM5            0x000B 
#define DSM_CARRIER_LOW_PWM6            0x000C 
#define DSM_CARRIER_LOW_CLC1            0x000D 
#define DSM_CARRIER_LOW_CLC2            0x000E 
#define DSM_CARRIER_LOW_CLC3            0x000F 
#define DSM_CARRIER_HIGH_MDCH           0x0000 //MDxCH pin 
#define DSM_CARRIER_HIGH_FOSC           0x0100 
#define DSM_CARRIER_HIGH_HFINTOSC       0x0200 
#define DSM_CARRIER_HIGH_CCP1           0x0700 
#define DSM_CARRIER_HIGH_CCP2           0x0800 
#define DSM_CARRIER_HIGH_PWM3           0x0900 
#define DSM_CARRIER_HIGH_PWM4           0x0A00 
#define DSM_CARRIER_HIGH_PWM5           0x0B00 
#define DSM_CARRIER_HIGH_PWM6           0x0C00 
#define DSM_CARRIER_HIGH_CLC1           0x0D00 
#define DSM_CARRIER_HIGH_CLC2           0x0E00 
#define DSM_CARRIER_HIGH_CLC3           0x0F00 
...
#define DAC4_CHANNEL              0x1A 
#define DAC3_CHANNEL              0x1B
...
#define INT_COG2                  0x309308
#define INT_PWM5                  0x309340
#define INT_PWM6                  0x309380
