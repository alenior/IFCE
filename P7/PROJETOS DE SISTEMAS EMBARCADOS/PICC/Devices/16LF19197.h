//////////// Standard Header file for the PIC16LF19197 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
#nolist
//////// Program memory: 32768x14  Data RAM: 2240  Stack: 16
//////// I/O: 60   Analog Pins: 45
//////// Data EEPROM: 256
//////// C Scratch area: 77   ID Location: 8000
//////// Fuses: NOEXTOSC,ECL,ECM,ECH,RSTOSC_HFINTRC_32MHZ,RSTOSC_HFINTRC_PLL
//////// Fuses: RSTOSC_EXT_PLL,RSTOSC_SOSC,RSTOSC_LFINTRC,RSTOSC_HFINTRC
//////// Fuses: RSTOSC_EXT,CLKOUT,NOCLKOUT,VBATEN,NOVBATEN,LCDPEN,NOLCDPEN
//////// Fuses: CKS,NOCKS,FCMEN,NOFCMEN,MCLR,NOMCLR,PUT_1MS,PUT_16MS
//////// Fuses: PUT_64MS,NOPUT,LPBOR,NOLPBOR,NOBROWNOUT,BROWNOUT_SW
//////// Fuses: BROWNOUT_NOSL,BROWNOUT,BORV27,BORV24,ZCDDIS,NOZCDDIS,PPS1WAY
//////// Fuses: NOPPS1WAY,STVREN,NOSTVREN,DEBUG,NODEBUG,WDT64,WDT128,WDT256
//////// Fuses: WDT512,WDT1024,WDT2048,WDT4096,WDT8192,WDT16384,WDT32768
//////// Fuses: WDT65536,WDT131072,WDT262144,WDT524299,WDT1048576,WDT2097152
...
//////// Fuses: WDTCLK_HFINTRC,WDTCLK_SW,BBSIZ64K,BBSIZ32K,BBSIZ16K,BBSIZ8K
//////// Fuses: BBSIZ4K,BBSIZ2K,BBSIZ1K,BBSIZ512,BOOTBLOCK,NOBOOTBLOCK,SAF
//////// Fuses: NOSAF,WRT,NOWRT,WRTB,NOWRTB,WRTC,NOWRTC,WRTD,NOWRTD,WRTSAF
//////// Fuses: NOWRTSAF,LVP,NOLVP,PROTECT,NOPROTECT
//////// 
...
//    PIN_D6,PIN_D7,PIN_E0,PIN_E1,PIN_E2,PIN_E3,PIN_E4,PIN_E5,PIN_E6,PIN_E7,
//    PIN_F0,PIN_F1,PIN_F2,PIN_F3,PIN_F4,PIN_F5,PIN_F6,PIN_F7,PIN_G0,PIN_G1,
//    PIN_G2,PIN_G3,PIN_G4,PIN_G5,PIN_G6,PIN_G7,PIN_H0,PIN_H1,PIN_H2,PIN_H3
// Input Functions: 
//    INT0,T0CK,T1CK,T1G,T2CK,T4CK,CCP1,CCP2,SMT1SIG,SMT1WIN,CWG1IN,CLCIN0,
//    CLCIN1,CLCIN2,CLCIN3,ADCACT,SCK1IN,SCL1IN,SDI1,SDA1IN,SS1IN,U1RX,U1CKIN,
//    U2RX,U2CKIN,T0CKI,T1CKI,T2CKI,T4CKI,CCP1IN,CCP2IN,RX1,RX2
// Output Functions: 
//    NULL,CLC1OUT,CLC2OUT,CLC3OUT,CLC4OUT,CWG1OUTA,CWG1OUTB,CWG1OUTC,CWG1OUTD,
//    CCP1OUT,CCP2OUT,PWM3OUT,PWM4OUT,U1TX,U1DT,U2TX,U2DT,C1OUT,C2OUT,SCK1OUT,
//    SCL1OUT,SDA1OUT,SDO1,T0OUT,ADGRDA,ADGRDB,RTCCOUT,PWM3,PWM4,TX1,DT1,TX2,DT2,
//    SCK1,SCL1,SDA1
//
...
_bif void set_input_level_g(int8 value);  
_bif void set_input_level_h(int8 value);  
...
_bif void set_open_drain_g(int8 value);  
_bif void set_open_drain_h(int8 value);  
...
_bif void port_g_pullups(int8 upmask);   
_bif void port_h_pullups(int8 upmask);   
...
_bif void set_slow_slew_g(int8 value); 
_bif void set_slow_slew_h(int8 value); 
...
#define T1_CLC1             0x0903 
#define T1_CLC2             0x0A03 
#define T1_CLC3             0x0B03 
#define T1_CLC4             0x0C03 
...
#define T1_GATE_TIMER2      0x028000 
#define T1_GATE_TIMER4      0x038000 
#define T1_GATE_SMT1        0x048000 
#define T1_GATE_CCP1        0x058000 
#define T1_GATE_CCP2        0x068000 
#define T1_GATE_PWM3        0x078000 
#define T1_GATE_PWM4        0x088000 
#define T1_GATE_CLC1        0x098000 
#define T1_GATE_CLC2        0x0A8000 
#define T1_GATE_CLC3        0x0B8000 
#define T1_GATE_CLC4        0x0C8000 
#define T1_GATE_COMP1       0x0D8000 
#define T1_GATE_COMP2       0x0E8000 
#define T1_GATE_ZCD1        0x0F8000 
#define T1_GATE_RTCC        0x108000 
...
#define T2_CLK_CLC1                                0x0900 
#define T2_CLK_CLC2                                0x0A00 
#define T2_CLK_CLC3                                0x0B00 
#define T2_CLK_CLC4                                0x0C00 
...
#define T2_RESET_FROM_PWM4                         0x05000000 
...
#define T2_RESET_FROM_RTCC                         0x0E000000 
...
#define T4_CLK_CLC1                                0x0900 
#define T4_CLK_CLC2                                0x0A00 
#define T4_CLK_CLC3                                0x0B00 
#define T4_CLK_CLC4                                0x0C00 
...
#define T4_RESET_FROM_PWM4                         0x05000000 
...
#define T4_RESET_FROM_RTCC                         0x0E000000 
...
// RTC Protoyptes:
_bif void setup_rtc(unsigned int8 mode);
_bif void setup_rtc(unsigned int8 mode, unsigned int8 calibration);
...
#define RTC_ENABLE               0x80
#define RTC_DISABLE              0
// One of the following may be OR'ed in with the above using |
#define RTC_CLOCK_EXT_60HZ       0x03
#define RTC_CLOCK_EXT_50HZ       0x02
#define RTC_CLOCK_MFINTOSC       0x01
...
#define CCP_CAPTURE_INPUT_RTCC           0x080000 
...
#define CP1_A0_F6       0x8004 
#define CP1_FVR_F6      0x8006 
#define CP1_VSS_F6      0x8007 
#define CP1_F0_A2       0x8010 
#define CP1_F5_A2       0x8011 
#define CP1_F3_A2       0x8012 
#define CP1_F7_A2       0x8013 
#define CP1_A0_A2       0x8014 
#define CP1_FVR_A2      0x8016 
#define CP1_VSS_A2      0x8017 
#define CP1_F0_DAC      0x8050 
#define CP1_F5_DAC      0x8051 
#define CP1_F3_DAC      0x8052 
#define CP1_F7_DAC      0x8053 
#define CP1_A0_DAC      0x8054 
#define CP1_FVR_DAC     0x8056
#define CP1_VSS_DAC     0x8057
#define CP1_F0_FVR      0x8060 
#define CP1_F5_FVR      0x8061 
#define CP1_F3_FVR      0x8062 
#define CP1_F7_FVR      0x8063 
#define CP1_A0_FVR      0x8064 
#define CP1_FVR_FVR     0x8066
#define CP1_VSS_FVR     0x8067
#define CP1_F0_VSS      0x8070 
#define CP1_F5_VSS      0x8071 
#define CP1_F3_VSS      0x8072 
#define CP1_F7_VSS      0x8073 
#define CP1_A0_VSS      0x8074 
#define CP1_FVR_VSS     0x8076
#define CP1_VSS_VSS     0x8077
//Optionally OR any of the following with the above
#define CP1_INT_L2H     0x0800
#define CP1_INT_H2L     0x0400
#define CP1_INVERT      0x1000
#define CP1_HYST        0x0200
#define CP1_SYNC        0x0100

//Pick one constant for COMP2
#define CP2_F0_F4       0x80000000 
#define CP2_F5_F4       0x80010000 
#define CP2_F3_F4       0x80020000 
#define CP2_F7_F4       0x80030000 
#define CP2_A0_F4       0x80040000 
#define CP2_FVR_F4      0x80060000 
#define CP2_VSS_F4      0x80070000 
#define CP2_F0_A2       0x80100000 
#define CP2_F5_A2       0x80110000 
#define CP2_F3_A2       0x80120000 
#define CP2_F7_A2       0x80130000 
#define CP2_A0_A2       0x80140000 
#define CP2_FVR_A2      0x80160000 
#define CP2_VSS_A2      0x80170000 
#define CP2_F0_LCDVREF  0x80400000 
#define CP2_F5_LCDVREF  0x80410000 
#define CP2_F3_LCDVREF  0x80420000 
#define CP2_F7_LCDVREF  0x80430000 
#define CP2_A0_LCDVREF  0x80440000 
#define CP2_FVR_LCDVREF 0x80460000
#define CP2_VSS_LCDVREF 0x80470000
#define CP2_F0_DAC      0x80500000 
#define CP2_F5_DAC      0x80510000 
#define CP2_F3_DAC      0x80520000 
#define CP2_F7_DAC      0x80530000 
#define CP2_A0_DAC      0x80540000 
#define CP2_FVR_DAC     0x80560000
#define CP2_VSS_DAC     0x80570000
#define CP2_F0_FVR      0x80600000 
#define CP2_F5_FVR      0x80610000 
#define CP2_F3_FVR      0x80620000 
#define CP2_F7_FVR      0x80630000 
#define CP2_A0_FVR      0x80640000 
#define CP2_FVR_FVR     0x80660000
#define CP2_VSS_FVR     0x80670000
#define CP2_F0_VSS      0x80700000 
#define CP2_F5_VSS      0x80710000 
#define CP2_F3_VSS      0x80720000 
#define CP2_F7_VSS      0x80730000 
#define CP2_A0_VSS      0x80740000 
#define CP2_FVR_VSS     0x80760000
#define CP2_VSS_VSS     0x80770000
//Optionally OR any of the following with the above
#define CP2_INT_L2H     0x08000000
#define CP2_INT_H2L     0x04000000
...
#define CWG_INPUT_CLC1                 0x7000 
#define CWG_INPUT_CLC2                 0x8000 
#define CWG_INPUT_CLC3                 0x9000 
#define CWG_INPUT_CLC4                 0xA000 
...
#define CLC_INPUT_TIMER0                    0x0B 
#define CLC_INPUT_TIMER1                    0x0C 
#define CLC_INPUT_TIMER2                    0x0D 
#define CLC_INPUT_TIMER4                    0x0E 
#define CLC_INPUT_SMT1                      0x0F 
#define CLC_INPUT_CCP1                      0x10 
#define CLC_INPUT_CCP2                      0x11 
#define CLC_INPUT_PWM3                      0x12 
#define CLC_INPUT_PWM4                      0x13 
#define CLC_INPUT_C1OUT                     0x14 
#define CLC_INPUT_C2OUT                     0x15 
#define CLC_INPUT_ZCD                       0x16 
#define CLC_INPUT_IOCIF                     0x17 
#define CLC_INPUT_CLC1                      0x18 
#define CLC_INPUT_CLC2                      0x19 
#define CLC_INPUT_CLC3                      0x1A 
#define CLC_INPUT_CLC4                      0x1B 
#define CLC_INPUT_U1DT                      0x1C 
#define CLC_INPUT_U1TX                      0x1D 
#define CLC_INPUT_SDO1                      0x1E 
#define CLC_INPUT_SCK1                      0x1F 
#define CLC_INPUT_RTCC                      0x20 
#define CLC_INPUT_CWG1A                     0x21 
#define CLC_INPUT_CWG1B                     0x22 
#define CLC_INPUT_U2DT                      0x23 
#define CLC_INPUT_U2TX                      0x24 
...
// One of the following may be OR'ed in with the above using |
#define SMT_WIN_INPUT_RTCC                  0x12000000 
#define SMT_WIN_INPUT_CLC4                  0x11000000 
#define SMT_WIN_INPUT_CLC3                  0x10000000 
#define SMT_WIN_INPUT_CLC2                  0x0F000000 
#define SMT_WIN_INPUT_CLC1                  0x0E000000 
#define SMT_WIN_INPUT_ZCD1                  0x0D000000 
#define SMT_WIN_INPUT_COMP2                 0x0C000000 
#define SMT_WIN_INPUT_COMP1                 0x0B000000 
#define SMT_WIN_INPUT_PWM4                  0x0A000000 
#define SMT_WIN_INPUT_PWM3                  0x09000000 
#define SMT_WIN_INPUT_CCP2                  0x08000000 
#define SMT_WIN_INPUT_CCP1                  0x07000000 
...
// One of the following may be OR'ed in with the above using |
#define SMT_SIG_INPUT_RTCC                  0x08000000 
#define SMT_SIG_INPUT_CLC4                  0x0F000000 
#define SMT_SIG_INPUT_CLC3                  0x0E000000 
#define SMT_SIG_INPUT_CLC2                  0x0D000000 
#define SMT_SIG_INPUT_CLC1                  0x0C000000 
#define SMT_SIG_INPUT_ZCD1                  0x0B000000 
#define SMT_SIG_INPUT_COMP2                 0x0A000000 
#define SMT_SIG_INPUT_COMP1                 0x09000000 
#define SMT_SIG_INPUT_PWM4                  0x08000000 
#define SMT_SIG_INPUT_PWM3                  0x07000000 
#define SMT_SIG_INPUT_CCP2                  0x06000000 
#define SMT_SIG_INPUT_CCP1                  0x05000000 
#define SMT_SIG_INPUT_TMR4                  0x04000000 
#define SMT_SIG_INPUT_TMR2                  0x03000000 
#define SMT_SIG_INPUT_TMR1                  0x02000000 
#define SMT_SIG_INPUT_TMR0                  0x01000000 
...
// LCD Prototypes:
_bif void setup_lcd(int32 mode, int8 prescale, int32 segments0_31, int16 segments32_47);
...
#define LCD_STATIC            0x00000081 
#define LCD_MUX12             0x00000082 
#define LCD_MUX13             0x00000083 
#define LCD_MUX14             0x00000084 
#define LCD_MUX15             0x00000085 
#define LCD_MUX16             0x00000086 
#define LCD_MUX17             0x00000087 
#define LCD_MUX18             0x00000088 
...
// LCD Clock Source
#define LCD_LFINTOSC          0x00000000   //default 
#define LCD_SOSC              0x00000010 
...
// LCD Voltage Source 
#define LCD_VOLTAGE_DISABLED                    0x00000000 
#define LCD_VOLTAGE_INT_LADDER_EXT              0x00010000 
#define LCD_VOLTAGE_INT_LADDER_VDD              0x00020000 
#define LCD_VOLTAGE_INT_LADDER_FVR              0x00030000 
#define LCD_VOLTAGE_INT_LADDER_EXT_CAPS_VLCD3   0x00040000 
#define LCD_VOLTAGE_INT_LADDER_EXT_CAPS_VDD     0x00050000 
#define LCD_VOLTAGE_CHARGE_PUMP                 0x00060000 
#define LCD_VOLTAGE_INT_LADDER_CHARGE_PUMP      0x00070000 
#define LCD_VOLTAGE_EXT_LADDER                  0x00080000 
 
// LCD Charge Pump Watchdog 
#define LCD_CP_WD_ENABLED     0x00000000 
#define LCD_CP_WD_DISABLED    0x00800000 
 
// LCD Charge Pump Low Power 
#define LCD_CP_NORMAL_POWER   0x00000000 
#define LCD_CP_LOW_POWER      0x00400000 
 
// LCD Charge Pump Range 
#define LCD_CP_RANGE_LOW      0x00000000 //3.6V Range 
#define LCD_CP_RANGE_HIGH     0x00200000 //5V Range 
 
// LCD Charge Pump Output 
#define LCD_VOLTAGE7          0x00000700 //3.50V Range 3.6V, 5.01V Range 5V 
#define LCD_VOLTAGE6          0x00000600 //3.40V Range 3.6V, 4.83V Range 5V 
#define LCD_VOLTAGE5          0x00000500 //3.30V Range 3.6V, 4.66V Range 5V 
#define LCD_VOLTAGE4          0x00000400 //3.20V Range 3.6V, 4.48V Range 5V 
#define LCD_VOLTAGE3          0x00000300 //3.10V Range 3.6V, 4.31V Range 5V 
#define LCD_VOLTAGE2          0x00000200 //3.00V Range 3.6V, 4.13V Range 5V 
#define LCD_VOLTAGE1          0x00000100 //2.90V Range 3.6V, 3.95V Range 5V 
#define LCD_VOLTAGE0          0x00000000 //2.80V Range 3.6V, 3.78V Range 5V 
...
#define ADC_TRIGGER_SMT2                0x0A    
#define ADC_TRIGGER_CCP1                0x0B    
#define ADC_TRIGGER_CCP2                0x0C    
#define ADC_TRIGGER_CCP3                0x0D    
#define ADC_TRIGGER_CCP4                0x0E    
#define ADC_TRIGGER_CCP5                0x0F    
#define ADC_TRIGGER_PWM6                0x10    
#define ADC_TRIGGER_PWM7                0x11    
#define ADC_TRIGGER_COMP1               0x12    
#define ADC_TRIGGER_COMP2               0x13    
#define ADC_TRIGGER_IOC                 0x14    
#define ADC_TRIGGER_CLC1                0x15    
#define ADC_TRIGGER_CLC2                0x16    
#define ADC_TRIGGER_CLC3                0x17    
#define ADC_TRIGGER_CLC4                0x18    
...
#define sAN24         0x00000100  //| D0
#define sAN25         0x00000200  //| D1
#define sAN26         0x00000400  //| D2
#define sAN27         0x00000800  //| D3
#define sAN28         0x00001000  //| D4
#define sAN29         0x00002000  //| D5
#define sAN30         0x00004000  //| D6
#define sAN31         0x00008000  //| D7
#define sAN32         0x00000001  //| E0
#define sAN33         0x00000002  //| E1
#define sAN35         0x00000008  //| E3
#define sAN36         0x00000010  //| E4
#define sAN37         0x00000020  //| E5
#define sAN38         0x00000040  //| E6
#define sAN39         0x00000080  //| E7
#define NO_ANALOGS             0  // None
#define ALL_ANALOG    0xDFFFFFFB  // A0 A1 A2 A3 A4 A6 A7 B0 B1 B2 B3 B4 B5 B6 B7 D0 D1 D2 D3 D4 D5 D6 D7 E0 E1 E3 E4 E5 E6 E7 
// Second parameter:
// OR together desired pins
#define sAN40         0x00000100  //| F0 
#define sAN41         0x00000200  //| F1
#define sAN42         0x00000400  //| F2 
#define sAN43         0x00000800  //| F3
#define sAN44         0x00001000  //| F4
#define sAN45         0x00002000  //| F5
#define sAN46         0x00004000  //| F6
#define sAN47         0x00008000  //| F7 
#define sAN48         0x00000001  //| G0
#define sAN49         0x00000002  //| G1
#define sAN50         0x00000004  //| G2
#define sAN51         0x00000008  //| G3
#define sAN52         0x00000010  //| G4
#define sAN54         0x00000040  //| G6
#define sAN55         0x00000080  //| G7
#define NO_ANALOGS_P2          0  // None
#define ALL_ANALOG_P2 0x0000FFDF  // F0 F1 F2 F3 F4 F5 F6 F7 G0 G1 G2 G3 G4 G6 G7
...
#define VBAT_DIV3_CHANNEL         0x39 
#define VLCD3_DIV4_CHANNEL        0x3A 
...
#define INT_IOC_E4                   0x34101610
#define INT_IOC_E4_L2H               0x14101610
#define INT_IOC_E4_H2L               0x24101610
#define INT_IOC_E5                   0x34201610
#define INT_IOC_E5_L2H               0x14201610
#define INT_IOC_E5_H2L               0x24201610
#define INT_IOC_E6                   0x34401610
#define INT_IOC_E6_L2H               0x14401610
#define INT_IOC_E6_H2L               0x24401610
#define INT_IOC_E7                   0x34801610
#define INT_IOC_E7_L2H               0x14801610
#define INT_IOC_E7_H2L               0x24801610
#define INT_IOC_G5                   0x36201610
#define INT_IOC_G5_L2H               0x16201610
#define INT_IOC_G5_H2L               0x26201610
...
#define INT_CLOCK_RECOVERY            0x301C80
#define INT_RTC                   0x301E40
#define INT_LCD                   0x301E80
