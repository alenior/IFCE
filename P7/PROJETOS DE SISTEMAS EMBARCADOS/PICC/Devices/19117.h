//////////// Standard Header file for the MCP19117 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
#nolist
//////// Program memory: 8192x14  Data RAM: 336  Stack: 8
//////// I/O: 13   Analog Pins: 8
//////// C Scratch area: 77   ID Location: 2000
//////// Fuses: WDT,NOWDT,PUT,NOPUT,MCLR,NOMCLR,PROTECT,NOPROTECT,BROWNOUT
//////// Fuses: NOBROWNOUT,NOWRT,DEBUG,NODEBUG
//////// 
...
#define sAN5            0x0010 //| B4 
#define sAN6            0x0020 //| B5 
#define sAN7            0x0040 //| B6 
#define NO_ANALOGS           0 // None
#define ALL_ANALOG      0x0F72 // A0 A1 A2 A3 B1 B4 B5 B6 

// Optional Second parameter for SETUP_ADC_PORTS, and parameter for SETUP_ADC_REFERENCE:
#define VSS_VDD         0x10000 //| Range 0 to Vdd
#define VSS_AVDD        0       //| Range 0 to AVdd

// Constants used in SET_ADC_CHANNEL() are:
// either use the channel number or one of the following
#define VIN_ANA_CHANNEL    0x18
#define VREF_CHANNEL       0x19
#define OV_REF_CHANNEL     0x1A
#define VBGR_CHANNEL       0x1B
#define VS_CHANNEL         0x1C
#define EA_CS_CHANNEL      0x1D
#define A2_CHANNEL         0x1E
#define PEDESTAL_CHANNEL   0x1F
#define IP_ADJ_CHANNEL     0x12
#define IP_OFF_REF_CHANNEL 0x13
#define VDR_DIV_N_CHANNEL  0x14
#define TEMP_SNS_CHANNEL   0x15
#define DLL_VCON_CHANNEL   0x16
#define SLPCMP_REF_CHANNEL 0x17
...
_bif unsigned int16 read_calibration_memory(unsigned int8 cal_reg); 
...
#define INT_GDUVLO                0x008804
#define INT_OVERVOLTAGE            0x008808
#define INT_OVERTEMP              0x008810
#define INT_DESAT_DETECT            0x008880
#define INT_RDA                   0x008740
#define INT_TBE                   0x008780
