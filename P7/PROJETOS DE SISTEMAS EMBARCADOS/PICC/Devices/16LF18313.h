//////////// Standard Header file for the PIC16LF18313 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
//////// Fuses: PPS1WAY,NOPPS1WAY,STVREN,NOSTVREN,DEBUG,NODEBUG,NOWRT,LVP
//////// Fuses: NOLVP,PROTECT,NOPROTECT,CPD,NOCPD
//////// 
...
// Input Functions: 
//    INT0,T0CK,T1CK,T1G,CCP1,CCP2,CWG1IN,MDCIN1,MDCIN2,MDMIN,SCK1IN,SCL1IN,SDI1,
//    SDA1IN,SS1IN,U1RX,U1CKIN,CLCIN0,CLCIN1,CLCIN2,CLCIN3,T0CKI,T1CKI,CCP1IN,
//    CCP2IN,RX1
// Output Functions: 
//    NULL,PWM5OUT,PWM6OUT,CLC1OUT,CLC2OUT,CWG1OUTA,CWG1OUTB,CWG1OUTC,CWG1OUTD,
//    CCP1OUT,CCP2OUT,U1TX,U1DT,C1OUT,C2OUT,SCK1OUT,SCL1OUT,SDO1,SDA1OUT,T0OUT,
...
#define ALL_ANALOG    0x00370000    // A0 A1 A2 A4 A5 
