//////////// Standard Header file for the PIC16F15313 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
//////// Fuses: RSTOSC_HFINTRC_PLL,RSTOSC_EXT_PLL,RSTOSC_LFINTRC
...
//////// Fuses: WDTCLK_LFINTRC,WDTCLK_HFINTRC,WDTCLK_SW,BBSIZ2K,BBSIZ1K
//////// Fuses: BBSIZ512,BOOTBLOCK,NOBOOTBLOCK,SAF,NOSAF,WRT,NOWRT,WRTB
//////// Fuses: NOWRTB,WRTC,NOWRTC,WRTSAF,NOWRTSAF,LVP,NOLVP,PROTECT
//////// Fuses: NOPROTECT
//////// 
...
//    SCK1IN,SCL1IN,SDI1,SDA1IN,SS1IN,U1RX,U1CK,U2RX,U2CK,T0CKI,T1CKI,T2CKI,
//    CCP1IN,CCP2IN,RX1,CK1,RX2,CK2
// Output Functions: 
...
//    C2OUT,SCK1OUT,SCL1OUT,SDO1,SDA1OUT,T0OUT,NCO1OUT,CLKROUT,PWM3,PWM4,PWM5,
//    PWM6,TX1,DT1,TX2,DT2,SCK1,SCL1,SDA1,TMR0OUT,NCO1
//
...
#define ALL_ANALOG    0x37000000  // A0 A1 A2 A4 A5 
