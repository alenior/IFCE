//////////// Standard Header file for the PIC16LF1566 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
//////// Fuses: BROWNOUT_NOSL,BROWNOUT,CLKOUT,NOCLKOUT,WRT_800,NOWRT,STVREN
//////// Fuses: NOSTVREN,BORV27,BORV19,LPBOR,NOLPBOR,DEBUG,NODEBUG,LVP,NOLVP
//////// 
...
#define PWM_AOE0         0x1000 //Enable Additional Output 0 
#define PWM_AOE1         0x2000 //Enable Additional Output 1 
#define PWM_AOE2         0x4000 //Enable Additional Output 2 
#define PWM_AOE3         0x8000 //Enable Additional Output 3 
...
//                SETUP_ADC2(), SET_ADC2_CHANNEL(), READ_ADC2(),
//                ADC2_DONE()
// ADC Prototypes:
_bif void setup_adc(int16 mode);
_bif void setup_adc2(int16 mode); 
_bif int8 read_adc(void);
_bif int8 read_adc(int8 mode);
_bif int16 read_adc(void);
_bif int16 read_adc(int8 mode);
_bif int8 read_adc2(void); 
_bif int8 read_adc2(int8 mode); 
_bif int16 read_adc2(void); 
_bif int16 read_adc2(int8 mode); 
_bif int1 adc_done(void);
_bif int1 adc2_done(void); 
// Constants used for SETUP_ADC() and SETUP_ADC2() are: 
...
_bif void set_adc2_channel(int8 channel);
// Constants used in SETUP_ADC_PORTS() are:
// First argument:
// OR together desired pins
#define sAN0          0x04000000  //| A2
#define sAN1          0x08000000  //| A3
#define sAN2          0x10000000  //| A4
#define sAN10         0x02000000  //| A1
#define sAN11         0x80000000  //| A7
#define sAN12         0x00000100  //| C0
#define sAN13         0x00000400  //| C2
#define sAN14         0x00001000  //| C4
#define sAN15         0x00004000  //| C6
#define sAN16         0x00010000  //| B0
#define sAN17         0x00040000  //| B2
#define sAN18         0x00100000  //| B4
#define sAN19         0x00400000  //| B6
#define sAN20         0x01000000  //| A0
#define sAN21         0x20000000  //| A5
#define sAN22         0x40000000  //| A6
#define sAN23         0x00000200  //| C1
#define sAN24         0x00000800  //| C3
#define sAN25         0x00002000  //| C5
#define sAN26         0x00008000  //| C7
#define sAN27         0x00020000  //| B1
#define sAN28         0x00080000  //| B3
#define sAN29         0x00200000  //| B5
#define sAN40         0x00800000  //| B7
#define NO_ANALOGS             0  // None
#define ALL_ANALOG    0xFFFFFF00  // A2 A3 A4 A1 A7 C0 C2 C4 C6 B0 B2 B4 B6 A0 A5 A6 C1 C3 C5 C7 B1 B3 B5 B7 
...
#define VREF_VDD      0x00000008  //| Range Vref- to Vdd
#define VREF_VREF     0x0000000A  //| Range Vref- to Vref+
#define VREF_FVR      0x0000000B  //| Range Vref- to FVR

// Constants used in SET_ADC_CHANNEL() and SET_ADC2_CHANNEL() are:
// either use the channel number or one of the following
#define ADC_POS_REFERENCE_CHANNEL  0x3B
