//////////// Standard Header file for the MCP19123 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
//////// Fuses: WDT,NOWDT,PUT,NOPUT,MCLR,NOMCLR,PROTECT,NOPROTECT,NOBROWNOUT
//////// Fuses: BROWNOUT_NOSL,NOWRT,DEBUG,NODEBUG
//////// 
...
_bif void port_a_current_source(int8 mask); 
...
#define T1_GATE_T1G2      0x8200 
#define T1_GATE_UV_OUT    0x8300 
...
#define CCP_COMPARE_TOGGLE               0x0A 
#define CCP_COMPARE_INT                  0x0C 
#define CCP_COMPARE_SPECIAL_EVENT        0x0F //CC1 resets TMR1, CC1 and CC2 starts ADC conversion, if ADC is enabled. 

#word   CCP_1       =                    getenv("SFR:CC1RL") 
#byte   CCP_1_LOW   =                    getenv("SFR:CC1RL") 
#byte   CCP_1_HIGH  =                    getenv("SFR:CC1RH") 

// CCP2 Prototypes:
_bif void setup_ccp2(int32 mode);
#word   CCP_2       =                    getenv("SFR:CC2RL") 
#byte   CCP_2_LOW   =                    getenv("SFR:CC2RL") 
#byte   CCP_2_HIGH  =                    getenv("SFR:CC2RH") 
...
#define ALL_ANALOG      0x0F36 // A0 A1 A2 A3 B1 B2 B4 B5 

// Optional Second parameter for SETUP_ADC_PORTS, and parameter for SETUP_ADC_REFERENCE:
#define VSS_VDD         0x10000 //| Range 0 to Vdd
#define VSS_VREF        0x20000 //| Range 0 to External ADref pin
#define VSS_ADREF       0       //| Range 0 to Internal AD Reference

// Constants used in SET_ADC_CHANNEL() are:
// either use the channel number or one of the following
#define EA_CLAMP_REF_CHANNEL              0x1F
#define ISENSE_CHANNEL                    0x1E
#define EA_AFTER_CLAMP_CHANNEL            0x1D
#define RAWI_CHANNEL                      0x1C
#define VIRTUAL_GND_CHANNEL               0x1B
#define GPA3_CHANNEL                      0x1A
#define VBRGR_REP_CHANNEL                 0x19
#define MASTERS_CURRENT_SENSE_CHANNEL     0x18
#define OC_REF_CHANNEL                    0x17
#define INPUT_OV_REF                      0x16
#define INPUT_UV_REF                      0x15
#define OUTPUT_OV_REF                     0x14
#define OUTPUT_UV_REF                     0x13
#define VREF_REP_CHANNEL                  0x12
#define VBRG_CHANNEL                      0x11
#define TEMP_SNS_CHANNEL                  0x10
#define AVG_OUTPUT_CURRENT_CHANNEL        0x0F
#define ISENSE_AFTER_GAIN_CHANNEL         0x0E
#define AVG_CURRENT_AFTER_SH_GAIN_CHANNEL 0x0D
#define EA_CHANNEL                        0x0C
#define VREG_REG_CHANNEL                  0x0B
#define OUTPUT_VOLTAGE_CHANNEL            0x0A
#define VIN_DIV_16_CHANNEL                0x09
#define RELEFF_CHANNEL                    0x08
...
#define INT_CCP1                  0x008704
#define INT_CCP2                  0x008708
#define INT_UVLO                  0x008801
#define INT_OVLO                  0x008802
#define INT_AD                    0x008840
#define INT_TMR1G                 0x008780
#define INT_OVERTEMP              0x008840
