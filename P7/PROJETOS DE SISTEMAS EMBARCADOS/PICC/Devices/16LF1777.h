//////////// Standard Header file for the PIC16LF1777 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
//    CCP8,COG1IN,COG2IN,COG3IN,COG4IN,MD1CL,MD1CH,MD1MOD,MD2CL,MD2CH,MD2MOD,
//    MD3CL,MD3CH,MD3MOD,MD4CL,MD4CH,MD4MOD,PRG1R,PRG1F,PRG2R,PRG2F,PRG3R,PRG3F,
//    PRG4R,PRG4F,CLCIN0,CLCIN1,CLCIN2,CLCIN3,ADCACT,SCK1IN,SCL1IN,SDI1,SDA1IN,
//    SS1IN,U1RX,U1CKIN,T0CKI,T1CKI,T3CKI,T5CKI,T2CKI,T4CKI,T6CKI,T8CKI,CCP1IN,
//    CCP2IN,CCP7IN,CCP8IN,RX1
// Output Functions: 
//    NULL,CLC1OUT,CLC2OUT,CLC3OUT,CLC4OUT,COG1A,COG1B,COG1C,COG1D,COG2A,COG2B,
//    COG2C,COG2D,COG3A,COG3B,COG3C,COG3D,COG4A,COG4B,COG4C,COG4D,CCP1OUT,
//    CCP2OUT,CCP7OUT,CCP8OUT,PWM3OUT,PWM4OUT,PWM9OUT,PWM10OUT,PWM5OUT,PWM6OUT,
//    PWM11OUT,PWM12OUT,SCK1OUT,SCL1OUT,SDA1OUT,SDO1,U1TX,U1DT,C1OUT,C2OUT,C3OUT,
//    C4OUT,C5OUT,C6OUT,C7OUT,C8OUT,MD1OUT,MD2OUT,MD3OUT,MD4OUT,PWM3,PWM4,PWM9,
//    PWM10,PWM5,PWM6,PWM11,PWM12,SCK1,SCL1,SDA1,TX1,DT1
//
...
#define CCP_CAPTURE_INPUT_C7OUT          0x070000 
#define CCP_CAPTURE_INPUT_C8OUT          0x080000 
...
_bif void set_pwm8_duty(int8 value);
...
_bif void setup_pwm10(int32 mode); 
_bif void set_pwm10_duty(int8 value); 
...
_bif void setup_pwm12(int16 mode); 
_bif void setup_pwm12(int16 mode, int32 mode1); 
_bif void set_pwm12_duty(int16 duty); 
_bif void set_pwm12_period(int16 period); 
_bif void set_pwm12_phase(int16 phase); 
_bif void set_pwm12_offset(int16 offset); 
_bif void enable_pwm12_interrrupt(int8 interrupt); 
_bif void disable_pwm12_interrupt(int8 interrupt); 
_bif void clear_pwm12_interrupt(int8 interrupt); 
_bif int1 pwm12_interrupt_active(int8 interrupt); 
// Constants used for SETUP_PWM3(), SETUP_PWM4(), SETUP_PWM9 and SETUP_PWM10() are: 
...
//Constants used for SETUP_PWM5(), SETUP_PWM6(), SETUP_PWM11() and SETUP_PWM12() first parameter are:  
...
// Constants used for SETUP_PWM5(), SETUP_PWM6(), SETUP_PWM11() and SETUP_PWM12() second parameter are: 
...
//DISABLE_PWM11_INTERRUPT(), CLEAR_PWM11_INTERRUPT(), PWM11_INTERRUPT_ACTIVE(), ENABLE_PWM12_INTERRUPT(), 
//DISABLE_PWM12_INTERRUPT(), CLEAR_PWM12_INTERRUPT(), and PWM12_INTERRUPT_ACTIVE() are: 
...
#bit PWM10OUT=getenv("BIT:PWM10OUT") 
#bit PWM11OUT=getenv("BIT:PWM11OUT") 
#bit PWM12OUT=getenv("BIT:PWM12OUT") 
...
_bif void setup_comparator_7(int16 mode); 
_bif void setup_comparator_8(int16 mode); 
...
#define CP5_PRG4_A2     0x8007 
#define CP5_VSS_A2      0x8008
#define CP5_OPA3_A2     0x8009
#define CP5_OPA4_A2     0x800A 
...
#define CP5_PRG4_B7     0x8017 
#define CP5_VSS_B7      0x8018
#define CP5_OPA3_B7     0x8019
#define CP5_OPA4_B7     0x801A 
...
#define CP5_PRG4_FVR2   0x8027 
#define CP5_VSS_FVR2    0x8028
#define CP5_OPA3_FVR2   0x8029
#define CP5_OPA4_FVR2   0x802A 
...
#define CP5_PRG4_PRG3   0x8037 
#define CP5_VSS_PRG3    0x8038
#define CP5_OPA3_PRG3   0x8039
#define CP5_OPA4_PRG3   0x803A 
#define CP5_A0_PRG4     0x8040 
#define CP5_C6_PRG4     0x8041 
#define CP5_C2_PRG4     0x8042 
#define CP5_C4_PRG4     0x8043 
#define CP5_C3_PRG4     0x8044 
#define CP5_FVR2_PRG4   0x8045 
#define CP5_PRG3_PRG4   0x8046 
#define CP5_PRG4_PRG4   0x8047 
#define CP5_VSS_PRG4    0x8048 
#define CP5_OPA3_PRG4   0x8049 
#define CP5_OPA4_PRG4   0x804A 
...
#define CP5_PRG4_DAC5   0x8057 
#define CP5_VSS_DAC5    0x8058
#define CP5_OPA3_DAC5   0x8059
#define CP5_OPA4_DAC5   0x805A 
#define CP5_A0_DAC6     0x8060 
#define CP5_C6_DAC6     0x8061 
#define CP5_C2_DAC6     0x8062 
#define CP5_C4_DAC6     0x8063 
#define CP5_C3_DAC6     0x8064 
#define CP5_FVR2_DAC6   0x8065 
#define CP5_PRG3_DAC6   0x8066 
#define CP5_PRG4_DAC6   0x8067 
#define CP5_VSS_DAC6    0x8068 
#define CP5_OPA3_DAC6   0x8069 
#define CP5_OPA4_DAC6   0x806A 
...
#define CP5_PRG4_DAC7   0x8077 
#define CP5_VSS_DAC7    0x8078
#define CP5_OPA3_DAC7   0x8079
#define CP5_OPA4_DAC7   0x807A 
#define CP5_A0_DAC8     0x8080 
#define CP5_C6_DAC8     0x8081 
#define CP5_C2_DAC8     0x8082 
#define CP5_C4_DAC8     0x8083 
#define CP5_C3_DAC8     0x8084 
#define CP5_FVR2_DAC8   0x8085 
#define CP5_PRG3_DAC8   0x8086 
#define CP5_PRG4_DAC8   0x8087 
#define CP5_VSS_DAC8    0x8088 
#define CP5_OPA3_DAC8   0x8089 
#define CP5_OPA4_DAC8   0x808A 
...
#define CP5_PRG4_VSS    0x8097 
#define CP5_VSS_VSS     0x8098
#define CP5_OPA3_VSS    0x8099
#define CP5_OPA4_VSS    0x809A 
//Optionally OR any of the following with the above
...
#define CP6_PRG4_A2     0x8007 
#define CP6_VSS_A2      0x8008
#define CP6_OPA3_A2     0x8009
#define CP6_OPA4_A2     0x800A 
...
#define CP6_PRG4_A6     0x8017 
#define CP6_VSS_A6      0x8018
#define CP6_OPA3_A6     0x8019
#define CP6_OPA4_A6     0x801A 
...
#define CP6_PRG4_FVR2   0x8027 
#define CP6_VSS_FVR2    0x8028
#define CP6_OPA3_FVR2   0x8029
#define CP6_OPA4_FVR2   0x802A 
...
#define CP6_PRG4_PRG3   0x8037 
#define CP6_VSS_PRG3    0x8038
#define CP6_OPA3_PRG3   0x8039
#define CP6_OPA4_PRG3   0x803A 
#define CP6_A0_PRG4     0x8040 
#define CP6_C6_PRG4     0x8041 
#define CP6_C2_PRG4     0x8042 
#define CP6_C4_PRG4     0x8043 
#define CP6_C3_PRG4     0x8044 
#define CP6_FVR2_PRG4   0x8045 
#define CP6_PRG3_PRG4   0x8046 
#define CP6_PRG4_PRG4   0x8047 
#define CP6_VSS_PRG4    0x8048 
#define CP6_OPA3_PRG4   0x8049 
#define CP6_OPA4_PRG4   0x804A 
...
#define CP6_PRG4_DAC5   0x8057 
#define CP6_VSS_DAC5    0x8058
#define CP6_OPA3_DAC5   0x8059
#define CP6_OPA4_DAC5   0x805A 
#define CP6_A0_DAC6     0x8060 
#define CP6_C6_DAC6     0x8061 
#define CP6_C2_DAC6     0x8062 
#define CP6_C4_DAC6     0x8063 
#define CP6_C3_DAC6     0x8064 
#define CP6_FVR2_DAC6   0x8065 
#define CP6_PRG3_DAC6   0x8066 
#define CP6_PRG4_DAC6   0x8067 
#define CP6_VSS_DAC6    0x8068 
#define CP6_OPA3_DAC6   0x8069 
#define CP6_OPA4_DAC6   0x806A 
...
#define CP6_PRG4_DAC7   0x8077 
#define CP6_VSS_DAC7    0x8078
#define CP6_OPA3_DAC7   0x8079
#define CP6_OPA4_DAC7   0x807A 
#define CP6_A0_DAC8     0x8080 
#define CP6_C6_DAC8     0x8081 
#define CP6_C2_DAC8     0x8082 
#define CP6_C4_DAC8     0x8083 
#define CP6_C3_DAC8     0x8084 
#define CP6_FVR2_DAC8   0x8085 
#define CP6_PRG3_DAC8   0x8086 
#define CP6_PRG4_DAC8   0x8087 
#define CP6_VSS_DAC8    0x8088 
#define CP6_OPA3_DAC8   0x8089 
#define CP6_OPA4_DAC8   0x808A 
...
#define CP6_PRG4_VSS    0x8097 
#define CP6_VSS_VSS     0x8098
#define CP6_OPA3_VSS    0x8099
#define CP6_OPA4_VSS    0x809A 
//Optionally OR any of the following with the above
...
// Constants used in setup_comparator_7() are: 
// Pick one of the following 
#define CP7_A0_A2       0x8000 
#define CP7_C6_A2       0x8001 
#define CP7_D4_A2       0x8002 
#define CP7_D5_A2       0x8003 
#define CP7_C3_A2       0x8004 
#define CP7_FVR2_A2     0x8005 
#define CP7_PRG3_A2     0x8006 
#define CP7_PRG4_A2     0x8007 
#define CP7_VSS_A2      0x8008 
#define CP7_OPA3_A2     0x8009 
#define CP7_OPA4_A2     0x800A 
#define CP7_A0_D6       0x8010 
#define CP7_C6_D6       0x8011 
#define CP7_D4_D6       0x8012 
#define CP7_D5_D6       0x8013 
#define CP7_C3_D6       0x8014 
#define CP7_FVR2_D6     0x8015 
#define CP7_PRG3_D6     0x8016 
#define CP7_PRG4_D6     0x8017 
#define CP7_VSS_D6      0x8018 
#define CP7_OPA3_D6     0x8019 
#define CP7_OPA4_D6     0x801A 
#define CP7_A0_FVR2     0x8020 
#define CP7_D4_FVR2     0x8021 
#define CP7_D5_FVR2     0x8022 
#define CP7_C4_FVR2     0x8023 
#define CP7_C3_FVR2     0x8024 
#define CP7_FVR2_FVR2   0x8025 
#define CP7_PRG3_FVR2   0x8026 
#define CP7_PRG4_FVR2   0x8027 
#define CP7_VSS_FVR2    0x8028 
#define CP7_OPA3_FVR2   0x8029 
#define CP7_OPA4_FVR2   0x802A 
#define CP7_A0_PRG3     0x8030 
#define CP7_C6_PRG3     0x8031 
#define CP7_D4_PRG3     0x8032 
#define CP7_D5_PRG3     0x8033 
#define CP7_C3_PRG3     0x8034 
#define CP7_FVR2_PRG3   0x8035 
#define CP7_PRG3_PRG3   0x8036 
#define CP7_PRG4_PRG3   0x8037 
#define CP7_VSS_PRG3    0x8038 
#define CP7_OPA3_PRG3   0x8039 
#define CP7_OPA4_PRG3   0x803A 
#define CP7_A0_PRG4     0x8040 
#define CP7_C6_PRG4     0x8041 
#define CP7_D4_PRG4     0x8042 
#define CP7_D5_PRG4     0x8043 
#define CP7_C3_PRG4     0x8044 
#define CP7_FVR2_PRG4   0x8045 
#define CP7_PRG3_PRG4   0x8046 
#define CP7_PRG4_PRG4   0x8047 
#define CP7_VSS_PRG4    0x8048 
#define CP7_OPA3_PRG4   0x8049 
#define CP7_OPA4_PRG4   0x804A 
#define CP7_A0_DAC5     0x8050 
#define CP7_C6_DAC5     0x8051 
#define CP7_D4_DAC5     0x8052 
#define CP7_D5_DAC5     0x8053 
#define CP7_C3_DAC5     0x8054 
#define CP7_FVR2_DAC5   0x8055 
#define CP7_PRG3_DAC5   0x8056 
#define CP7_PRG4_DAC5   0x8057 
#define CP7_VSS_DAC5    0x8058 
#define CP7_OPA3_DAC5   0x8059 
#define CP7_OPA4_DAC5   0x805A 
#define CP7_A0_DAC6     0x8060 
#define CP7_C6_DAC6     0x8061 
#define CP7_D4_DAC6     0x8062 
#define CP7_D5_DAC6     0x8063 
#define CP7_C3_DAC6     0x8064 
#define CP7_FVR2_DAC6   0x8065 
#define CP7_PRG3_DAC6   0x8066 
#define CP7_PRG4_DAC6   0x8067 
#define CP7_VSS_DAC6    0x8068 
#define CP7_OPA3_DAC6   0x8069 
#define CP7_OPA4_DAC6   0x806A 
#define CP7_A0_DAC7     0x8070 
#define CP7_C6_DAC7     0x8071 
#define CP7_D4_DAC7     0x8072 
#define CP7_D5_DAC7     0x8073 
#define CP7_C3_DAC7     0x8074 
#define CP7_FVR2_DAC7   0x8075 
#define CP7_PRG3_DAC7   0x8076 
#define CP7_PRG4_DAC7   0x8077 
#define CP7_VSS_DAC7    0x8078 
#define CP7_OPA3_DAC7   0x8079 
#define CP7_OPA4_DAC7   0x807A 
#define CP7_A0_DAC8     0x8080 
#define CP7_C6_DAC8     0x8081 
#define CP7_D4_DAC8     0x8082 
#define CP7_D5_DAC8     0x8083 
#define CP7_C3_DAC8     0x8084 
#define CP7_FVR2_DAC8   0x8085 
#define CP7_PRG3_DAC8   0x8086 
#define CP7_PRG4_DAC8   0x8087 
#define CP7_VSS_DAC8    0x8088 
#define CP7_OPA3_DAC8   0x8089 
#define CP7_OPA4_DAC8   0x808A 
#define CP7_A0_VSS      0x8090 
#define CP7_C6_VSS      0x8091 
#define CP7_D4_VSS      0x8092 
#define CP7_D5_VSS      0x8093 
#define CP7_C3_VSS      0x8094 
#define CP7_FVR2_VSS    0x8095 
#define CP7_PRG3_VSS    0x8096 
#define CP7_PRG4_VSS    0x8097 
#define CP7_VSS_VSS     0x8098 
#define CP7_OPA3_VSS    0x8099 
#define CP7_OPA4_VSS    0x809A 
//Optionally OR any of the following with the above 
#define CP7_INT_L2H     0x20000 
#define CP7_INT_H2L     0x10000 
#define CP7_LOW_POWER   0x2000 
#define CP7_INVERT      0x1000 
#define CP7_FILTER      0x0800 
#define CP7_HYST        0x0200 
#define CP7_SYNC        0x0100 

// Constants used in setup_comparator_8() are: 
// Pick one of the following 
#define CP8_A0_A2       0x8000 
#define CP8_C6_A2       0x8001 
#define CP8_D3_A2       0x8002 
#define CP8_D5_A2       0x8003 
#define CP8_C3_A2       0x8004 
#define CP8_FVR2_A2     0x8005 
#define CP8_PRG3_A2     0x8006 
#define CP8_PRG4_A2     0x8007 
#define CP8_VSS_A2      0x8008 
#define CP8_OPA3_A2     0x8009 
#define CP8_OPA4_A2     0x800A 
#define CP8_A0_D7       0x8010 
#define CP8_C6_D7       0x8011 
#define CP8_D3_D7       0x8012 
#define CP8_D5_D7       0x8013 
#define CP8_C3_D7       0x8014 
#define CP8_FVR2_D7     0x8015 
#define CP8_PRG3_D7     0x8016 
#define CP8_PRG4_D7     0x8017 
#define CP8_VSS_D7      0x8018 
#define CP8_OPA3_D7     0x8019 
#define CP8_OPA4_D7     0x801A 
#define CP8_A0_FVR2     0x8020 
#define CP8_D3_FVR2     0x8021 
#define CP8_D5_FVR2     0x8022 
#define CP8_C4_FVR2     0x8023 
#define CP8_C3_FVR2     0x8024 
#define CP8_FVR2_FVR2   0x8025 
#define CP8_PRG3_FVR2   0x8026 
#define CP8_PRG4_FVR2   0x8027 
#define CP8_VSS_FVR2    0x8028 
#define CP8_OPA3_FVR2   0x8029 
#define CP8_OPA4_FVR2   0x802A 
#define CP8_A0_PRG3     0x8030 
#define CP8_C6_PRG3     0x8031 
#define CP8_D3_PRG3     0x8032 
#define CP8_D5_PRG3     0x8033 
#define CP8_C3_PRG3     0x8034 
#define CP8_FVR2_PRG3   0x8035 
#define CP8_PRG3_PRG3   0x8036 
#define CP8_PRG4_PRG3   0x8037 
#define CP8_VSS_PRG3    0x8038 
#define CP8_OPA3_PRG3   0x8039 
#define CP8_OPA4_PRG3   0x803A 
#define CP8_A0_PRG4     0x8040 
#define CP8_C6_PRG4     0x8041 
#define CP8_D3_PRG4     0x8042 
#define CP8_D5_PRG4     0x8043 
#define CP8_C3_PRG4     0x8044 
#define CP8_FVR2_PRG4   0x8045 
#define CP8_PRG3_PRG4   0x8046 
#define CP8_PRG4_PRG4   0x8047 
#define CP8_VSS_PRG4    0x8048 
#define CP8_OPA3_PRG4   0x8049 
#define CP8_OPA4_PRG4   0x804A 
#define CP8_A0_DAC5     0x8050 
#define CP8_C6_DAC5     0x8051 
#define CP8_D3_DAC5     0x8052 
#define CP8_D5_DAC5     0x8053 
#define CP8_C3_DAC5     0x8054 
#define CP8_FVR2_DAC5   0x8055 
#define CP8_PRG3_DAC5   0x8056 
#define CP8_PRG4_DAC5   0x8057 
#define CP8_VSS_DAC5    0x8058 
#define CP8_OPA3_DAC5   0x8059 
#define CP8_OPA4_DAC5   0x805A 
#define CP8_A0_DAC6     0x8060 
#define CP8_C6_DAC6     0x8061 
#define CP8_D3_DAC6     0x8062 
#define CP8_D5_DAC6     0x8063 
#define CP8_C3_DAC6     0x8064 
#define CP8_FVR2_DAC6   0x8065 
#define CP8_PRG3_DAC6   0x8066 
#define CP8_PRG4_DAC6   0x8067 
#define CP8_VSS_DAC6    0x8068 
#define CP8_OPA3_DAC6   0x8069 
#define CP8_OPA4_DAC6   0x806A 
#define CP8_A0_DAC7     0x8070 
#define CP8_C6_DAC7     0x8071 
#define CP8_D3_DAC7     0x8072 
#define CP8_D5_DAC7     0x8073 
#define CP8_C3_DAC7     0x8074 
#define CP8_FVR2_DAC7   0x8075 
#define CP8_PRG3_DAC7   0x8076 
#define CP8_PRG4_DAC7   0x8077 
#define CP8_VSS_DAC7    0x8078 
#define CP8_OPA3_DAC7   0x8079 
#define CP8_OPA4_DAC7   0x807A 
#define CP8_A0_DAC8     0x8080 
#define CP8_C6_DAC8     0x8081 
#define CP8_D3_DAC8     0x8082 
#define CP8_D5_DAC8     0x8083 
#define CP8_C3_DAC8     0x8084 
#define CP8_FVR2_DAC8   0x8085 
#define CP8_PRG3_DAC8   0x8086 
#define CP8_PRG4_DAC8   0x8087 
#define CP8_VSS_DAC8    0x8088 
#define CP8_OPA3_DAC8   0x8089 
#define CP8_OPA4_DAC8   0x808A 
#define CP8_A0_VSS      0x8090 
#define CP8_C6_VSS      0x8091 
#define CP8_D3_VSS      0x8092 
#define CP8_D5_VSS      0x8093 
#define CP8_C3_VSS      0x8094 
#define CP8_FVR2_VSS    0x8095 
#define CP8_PRG3_VSS    0x8096 
#define CP8_PRG4_VSS    0x8097 
#define CP8_VSS_VSS     0x8098 
#define CP8_OPA3_VSS    0x8099 
#define CP8_OPA4_VSS    0x809A 
//Optionally OR any of the following with the above 
#define CP8_INT_L2H     0x20000 
#define CP8_INT_H2L     0x10000 
#define CP8_LOW_POWER   0x2000 
#define CP8_INVERT      0x1000 
#define CP8_FILTER      0x0800 
#define CP8_HYST        0x0200 
#define CP8_SYNC        0x0100 
...
#bit C7OUT = getenv("SFR:CM7CON0").6 
#bit C8OUT = getenv("SFR:CM8CON0").6 
...
//                              SETUP_DAC6(), DAC_WRITE6() 
//                              SETUP_DAC7(), DAC_WRITE7()
//                              SETUP_DAC8(), DAC_WRITE8() 
// DAC Prototypes:
...
_bif void setup_dac6(int8 mode); 
_bif void setup_dac7(int8 mode);
_bif void setup_dac8(int8 mode); 
...
_bif void dac_write6(int16 value); 
_bif void dac_write7(int8 value);
_bif void dac_write8(int8 value); 
...
_bif void setup_opamp4(int32 mode); 
...
#define OPAMP_I_TO_FVR1                   0x0006 //Inverting input connects to FVR Buffer 1 output, OPAMP1 and OPAMP2 only 
...
#define OPAMP_I_TO_DAC5                   0x0002 //Inverting input connects to DAC5 output, OPAMP3 and OPAMP4 only 
#define OPAMP_I_TO_DAC6                   0x0003 //Inverting input connects to DAC6 output, OPAMP3 and OPAMP4 only 
#define OPAMP_I_TO_DAC7                   0x0004 //Inverting input connects to DAC7 output, OPAMP3 and OPAMP4 only 
#define OPAMP_I_TO_DAC8                   0x0005 //Inverting input connects to DAC8 output, OPAMP3 and OPAMP4 only 
#define OPAMP_I_TO_FVR2                   0x0006 //Inverting input connects to FVR Buffer 2 output, OPAMP3 and OPAMP4 only 
#define OPAMP_I_TO_PRG3                   0x0007 //Inverting input connects to PRG3 output, OPAMP3 and OPAMP4 only 
#define OPAMP_I_TO_PRG4                   0x0008 //Inverting input connects to RPG4 output, OPAMP3 and OPAMP4 only 
// One of the following may be OR'ed in with the above using |    
...
#define OPAMP_NI_TO_FVR1                  0x0060 //Non-inverting input connects to FVR Buffer 1 output, OPAMP1 and OPAMP2 only 
...
#define OPAMP_NI_TO_DAC5                  0x0020 //Non-inverting input connects to DAC5 output, OPAMP3 and OPAMP4 only 
#define OPAMP_NI_TO_DAC6                  0x0030 //Non-inverting input connects to DAC6 output, OPAMP3 and OPAMP4 only 
#define OPAMP_NI_TO_DAC7                  0x0040 //Non-inverting input connects to DAC7 output, OPAMP3 and OPAMP4 only 
#define OPAMP_NI_TO_DAC8                  0x0050 //Non-inverting input connects to DAC8 output, OPAMP3 and OPAMP4 only 
#define OPAMP_NI_TO_FVR2                  0x0060 //Non-inverting input connects to FVR Buffer 2 output, OPAMP3 and OPAMP4 only 
#define OPAMP_NI_TO_PRG3                  0x0070 //Non-inverting input connects to PRG3 output, OPAMP3 and OPAMP4 only 
#define OPAMP_NI_TO_PRG4                  0x0080 //Non-inverting input connects to PRG4 output, OPAMP3 and OPAMP4 only 
// One of the following may be OR'ed in with the above using |    
...
#define OPAMP_OVERRIDE_SOURCE_CCP8      0x030000 
...
#define OPAMP_OVERRIDE_SOURCE_PWM10     0x070000 
...
#define OPAMP_OVERRIDE_SOURCE_PWM12     0x0B0000 
...
#define OPAMP_OVERRIDE_SOURCE_C7OUT     0x120000 
#define OPAMP_OVERRIDE_SOURCE_C8OUT     0x130000 
...
#define OPAMP_OVERRIDE_SOURCE_COG3A     0x180000 //OPAMP3 and OPAMP4 only 
#define OPAMP_OVERRIDE_SOURCE_COG3B     0x190000 //OPAMP3 and OPAMP4 only 
#define OPAMP_OVERRIDE_SOURCE_COG3C     0x1A0000 //OPAMP3 and OPAMP4 only 
#define OPAMP_OVERRIDE_SOURCE_COG3D     0x1B0000 //OPAMP3 and OPAMP4 only 
#define OPAMP_OVERRIDE_SOURCE_COG4A     0x1C0000 //OPAMP3 and OPAMP4 only 
#define OPAMP_OVERRIDE_SOURCE_COG4B     0x1D0000 //OPAMP3 and OPAMP4 only 
#define OPAMP_OVERRIDE_SOURCE_COG4C     0x1E0000 //OPAMP3 and OPAMP4 only 
#define OPAMP_OVERRIDE_SOURCE_COG4D     0x1F0000 //OPAMP3 and OPAMP4 only 
// The following may be OR'ed in with the above using |    
...
_bif void setup_prg4(int16 mode, int8 current, int8 rising_source, int8 falling_source); 
_bif int8 prg1_status(void);
_bif int8 prg2_status(void); 
_bif int8 prg3_status(void); 
_bif int8 prg4_status(void); 
...
#define PRG_INPUT_SOURCE_DAC5                   0x030000 //PRG3 and PRG4 only 
#define PRG_INPUT_SOURCE_DAC6                   0x040000 //PRG3 and PRG4 only 
#define PRG_INPUT_SOURCE_DAC7                   0x050000 //PRG3 and PRG4 only 
#define PRG_INPUT_SOURCE_DAC8                   0x060000 //PRG3 and PRG4 only 
#define PRG_INPUT_SOURCE_OPA1OUT                0x080000 //PRG1 and PRG2 only 
#define PRG_INPUT_SOURCE_OPA2OUT                0x090000 //PRG1 and PRG2 only 
#define PRG_INPUT_SOURCE_OPA3OUT                0x080000 //PRG3 and PRG4 only 
#define PRG_INPUT_SOURCE_OPA4OUT                0x090000 //PRG3 and PRG4 only 
...
#define PRG_RISING_SOURCE_C5OUT                 0x04 //PRG3 and PRG4 only 
#define PRG_RISING_SOURCE_C6OUT                 0x05 //PRG3 and PRG4 only 
#define PRG_RISING_SOURCE_C7OUT                 0x06 //PRG3 and PRG4 only 
...
#define PRG_RISING_SOURCE_PWM10                 0x0B //PRG1 and PRG2 only 
#define PRG_RISING_SOURCE_PWM5                  0x0C //PRG3 and PRG4 only 
#define PRG_RISING_SOURCE_PWM6                  0x0D //PRG3 and PRG4 only 
#define PRG_RISING_SOURCE_PWM11                 0x0E //PRG3 and PRG4 only 
#define PRG_RISING_SOURCE_PWM12                 0x0F //PRG3 and PRG4 only 
...
#define PRG_FALLING_SOURCE_C5OUT                0x04 //PRG3 and PRG4 only 
#define PRG_FALLING_SOURCE_C6OUT                0x05 //PRG3 and PRG4 only 
#define PRG_FALLING_SOURCE_C7OUT                0x06 //PRG3 and PRG4 only 
...
#define PRG_FALLING_SOURCE_PWM10                0x0B //PRG1 and PRG2 only 
#define PRG_FALLING_SOURCE_PWM5                 0x0C //PRG3 and PRG4 only 
#define PRG_FALLING_SOURCE_PWM6                 0x0D //PRG3 and PRG4 only 
#define PRG_FALLING_SOURCE_PWM11                0x0E //PRG3 and PRG4 only 
#define PRG_FALLING_SOURCE_PWM12                0x0F //PRG3 and PRG4 only 
...
#bit PRG4GO = getenv("SFR:PRG4CON0").0 
#bit PRG4OS = getenv("SFR:PRG4CON0").1 
...
//                SET_COG3_BLANKING(), COG3_STATUS(), COG3_RESTART(), 
//                SETUP_COG4(), SET_COG4_DEAD_BAND(), SET_COG4_PHASE(), 
//                SET_COG4_BLANKING(), COG4_STATUS(), COG4_RESTART() 
// COG Prototypes:
...
_bif void setup_cog4(int32 mode, int16 shutdown, int8 steering); 
...
_bif void set_cog4_dead_band(int8 falling_deadband, int8 rising_deadband); 
...
_bif void set_cog4_phase(int8 falling_phase, int8 rising_phase); 
...
_bif void set_cog4_blanking(int8 falling_value, int8 rising_value); 
_bif int8 cog_status(void);
_bif int8 cog2_status(void); 
_bif int8 cog3_status(void); 
_bif int8 cog4_status(void); 
_bif void cog_restart(void);
_bif void cog2_restart(void); 
_bif void cog3_restart(void); 
_bif void cog4_restart(void); 
// Constants used in SETUP_COG(), SETUP_COG2(), SETUP_COG3() and SETUP_COG4() first parameter are: 
...
#define COG_FALLING_SOURCE_C5OUT                 0x050000 //COG3 and COG4 only 
#define COG_FALLING_SOURCE_C4OUT                 0x050000 //COG1 and COG2 only 
#define COG_FALLING_SOURCE_C6OUT                 0x050000 //COG3 and COG4 only 
#define COG_FALLING_SOURCE_CCP1                  0x060000 //COG1 and COG3 only 
#define COG_FALLING_SOURCE_CCP7                  0x060000 //COG3 and COG4 only 
#define COG_FALLING_SOURCE_CCP2                  0x070000 //COG1 and COG2 only 
#define COG_FALLING_SOURCE_CCP8                  0x070000 //COG3 and COG4 only 
#define COG_FALLING_SOURCE_PWM3                  0x080000 //COG1 and COG2 only 
#define COG_FALLING_SOURCE_PWM9                  0x080000 //COG3 and COG4 only 
#define COG_FALLING_SOURCE_PWM4                  0x090000 //COG1 and COG2 only 
#define COG_FALLING_SOURCE_PWM10                 0x090000 //COG4 only 
#define COG_FALLING_SOURCE_PWM5                  0x0A0000 //COG1 and COG2 only 
#define COG_FALLING_SOURCE_PWM11                 0x0A0000 //COG3 and COG4 only 
#define COG_FALLING_SOURCE_PWM6                  0x0B0000 //COG1 and COG2 only 
#define COG_FALLING_SOURCE_PWM12                 0x0B0000 //COG4 only 
#define COG_FALLING_SOURCE_MDx                   0x0C0000 //COG1 - MD1, COG2 - MD2, COG3 - MD3, COG4 - MD3 
...
#define COG_RISING_SOURCE_C5OUT                  0x05000000 //COG3 and COG4 only 
#define COG_RISING_SOURCE_C4OUT                  0x05000000 //COG1 and COG2 only 
#define COG_RISING_SOURCE_C6OUT                  0x05000000 //COG3 and COG4 only 
#define COG_RISING_SOURCE_CCP1                   0x06000000 //COG1 and COG2 only
#define COG_RISING_SOURCE_CCP7                   0x06000000 //COG3 and COG4 only 
#define COG_RISING_SOURCE_CCP2                   0x07000000 //COG1 and COG2 only 
#define COG_RISING_SOURCE_CCP8                   0x07000000 //COG3 and COG4 only 
#define COG_RISING_SOURCE_PWM3                   0x08000000 //COG1 and COG2 only 
#define COG_RISING_SOURCE_PWM9                   0x08000000 //COG3 and COG4 only 
#define COG_RISING_SOURCE_PWM4                   0x09000000 //COG1 and COG2 only 
#define COG_RISING_SOURCE_PWM10                  0x09000000 //COG4 only 
#define COG_RISING_SOURCE_PWM5                   0x0A000000 //COG1 and COG2 only 
#define COG_RISING_SOURCE_PWM11                  0x0A000000 //COG3 and COG4 only 
#define COG_RISING_SOURCE_PWM6                   0x0B000000 //COG1 and COG2 only 
#define COG_RISING_SOURCE_PWM12                  0x0B000000 //COG4 only 
#define COG_RISING_SOURCE_MDx                    0x0C000000 //COG1 - MD1, COG2 - MD2, COG3 - MD3, COG4 - MD3 
...
// Constants used in SETUP_COG(), SETUP_COG2(), SETUP_COG3() and SETUP_COG4() second parameter are:  
...
#define COG_SHUTDONW_ON_C5OUT                    0x0800 //COG3 and COG4 only 
#define COG_SHUTDOWN_ON_C4OUT                    0x1000 //COG1 and COG2 only 
#define COG_SHUTDOWN_ON_C6OUT                    0x1000 //COG3 and COG4 only 
#define COG_SHUTDOWN_ON_CLC2                     0x2000 //COG1 and COG2 only 
#define COG_SHUTDOWN_ON_CLC4                     0x2000 //COG3 and COG4 only 
#define COG_SHUTDOWN_ON_TIMER2                   0x4000 //COG1 and COG2 only 
#define COG_SHUTDOWN_ON_TIMER6                   0x4000 //COG3 and COG4 only 
#define COG_SHUTDOWN_ON_TIMER4                   0x8000 //COG1 and COG2 only 
#define COG_SHUTDOWN_ON_TIMER8                   0x8000 //COG3 and COG4 only 
...
// Constants used in SETUP_COG(), SETUP_COG2(), SETUP_COG3() and SETUP_COG4() third prameter are: 
// One of the following may be used:
...
////////////////////////////////////////////////////////////////// DSM
// Data Signal Modulator Functions: SETUP_DSM(), SETUP_DSM2(), 
//                                  SETUP_DSM3(), SETUP_DSM4(), 
// DSM Prototypes:
...
_bif void setup_dsm4(unsigned int16 mode, unsigned int8 source, unsigned int16 carrier); 
// Constants used in SETUP_DSM(), SETUP_DSM2(), SETUP_DSM3() and SETUP_DSM4() first parameter are: 
...
#define INT_COMP7                 0x309504
#define INT_COMP8                 0x309508
#define INT_COG4                  0x309520
#define INT_CCP8                  0x309580
#define INT_PWM12                 0x309608
...
#define INT_IOC_D0                0x33010B08
#define INT_IOC_D0_L2H            0x13010B08
#define INT_IOC_D0_H2L            0x23010B08
#define INT_IOC_D1                0x33020B08
#define INT_IOC_D1_L2H            0x13020B08
#define INT_IOC_D1_H2L            0x23020B08
#define INT_IOC_D2                0x33040B08
#define INT_IOC_D2_L2H            0x13040B08
#define INT_IOC_D2_H2L            0x23040B08
#define INT_IOC_D3                0x33080B08
#define INT_IOC_D3_L2H            0x13080B08
#define INT_IOC_D3_H2L            0x23080B08
#define INT_IOC_D4                0x33100B08
#define INT_IOC_D4_L2H            0x13100B08
#define INT_IOC_D4_H2L            0x23100B08
#define INT_IOC_D5                0x33200B08
#define INT_IOC_D5_L2H            0x13200B08
#define INT_IOC_D5_H2L            0x23200B08
#define INT_IOC_D6                0x33400B08
#define INT_IOC_D6_L2H            0x13400B08
#define INT_IOC_D6_H2L            0x23400B08
#define INT_IOC_D7                0x33800B08
#define INT_IOC_D7_L2H            0x13800B08
#define INT_IOC_D7_H2L            0x23800B08
...
#define INT_RD                    0x30FF0B08
#define INT_RD0                   0x32010B08
#define INT_RD0_L2H               0x12010B08
#define INT_RD0_H2L               0x22010B08
#define INT_RD1                   0x32020B08
#define INT_RD1_L2H               0x12020B08
#define INT_RD1_H2L               0x22020B08
#define INT_RD2                   0x32040B08
#define INT_RD2_L2H               0x12040B08
#define INT_RD2_H2L               0x22040B08
#define INT_RD3                   0x32080B08
#define INT_RD3_L2H               0x12080B08
#define INT_RD3_H2L               0x22080B08
#define INT_RD4                   0x32100B08
#define INT_RD4_L2H               0x12100B08
#define INT_RD4_H2L               0x22100B08
#define INT_RD5                   0x32200B08
#define INT_RD5_L2H               0x12200B08
#define INT_RD5_H2L               0x22200B08
#define INT_RD6                   0x32400B08
#define INT_RD6_L2H               0x12400B08
#define INT_RD6_H2L               0x22400B08
#define INT_RD7                   0x32800B08
#define INT_RD7_L2H               0x12800B08
#define INT_RD7_H2L               0x22800B08
