...
#define EXAMPLE_EZAPP_SECURITY
   ...
   // in system.h, EZAPP_CHECK_AUTHENTICATION() macro points to
   // MyEZAppAuthCheck().  EXAMPLE_EZAPP_SECURITY macro was added to MPLAB X's
   // project settings, so that EZAPP_CHECK_AUTHENTICATION() macro would be
   // applied to all compiled units.
