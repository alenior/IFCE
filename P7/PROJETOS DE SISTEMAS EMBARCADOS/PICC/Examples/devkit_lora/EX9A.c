...
////                                                                   ////
////  This exercise is an example of P2P Listening End Device,         ////
////  Listening End Devices are basically the combination of the P2P   ////
////  Base Station and the P2P End Device.  It constantly listens for  ////
////  messages like a Base Station and can response to messages sent   ////
////  to it's address, while also initiating communication by sending  ////
////  a message to another device's address.  In this exercise pushing ////
////  push button B4 will cause it to send the current ADC reading for ////
////  POT A0 to the other board to set the brightness of the C1 LED.   ////
////  Additionally pushing push button D3 will send the flash rate to  ////
////  the other board to set the flash rate of the C1 LED from 0 to    ////
////  5Hz in 1Hz increments.  Additionally it can receive the same     ////
////  messages from other board to set it's C1 LEDs brightness and     ////
////  flash rate.                                                      ////
////                                                                   ////
///////////////////////////////////////////////////////////////////////////
...
#define OTHER_DEVICES_ADDR    0x02
