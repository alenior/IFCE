...
////  for time.h.                                                    ////
////                                                                 ////
////  When running, current time is continously displaced on the     ////
...
/////////////////////////////////////////////////////////////////////////
   ...
   #use rs232(UART1, baud=9600, stream=STREAM_USER_UART) //Text through the UART
   ...
   #use rs232(baud=9600, UART1, stream=STREAM_USER_UART) //Text through the UART
#endif
